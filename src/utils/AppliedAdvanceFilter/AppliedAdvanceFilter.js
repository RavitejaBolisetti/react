...
export default function AppliedAdvanceFilter(props) {
    const { advanceFilter = false, title, showAddButton = true, showChangeHistoryButton = false, showChangeHistoryList, filterString, from, onFinish, onFinishFailed, extraParams, removeFilter, handleResetFilter, handleClearInSearch, onSearchHandle, setAdvanceSearchVisible, handleReferesh, handleButtonClick, validator = searchValidator } = props;
