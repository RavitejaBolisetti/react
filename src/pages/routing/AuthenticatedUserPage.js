...
import { GeoPage, ProductHierarchyPage, ProductMasterPage, HierarchyAttributeMasterPage,ConfigParamEditPage } from 'pages/common';
...
export const AuthenticatedUserPage = () => {
    return (
        <Routes>
            ...
            <Route path={routing.ROUTING_COMMON_CONFIG_PARAM_EDIT} element={<ConfigParamEditPage />} />
