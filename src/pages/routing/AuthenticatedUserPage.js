...
import { GeoPage, ProductHierarchyPage, ProductMasterPage, HierarchyAttributeMasterPage, DealerHierarchy } from 'pages/common';
...
export const AuthenticatedUserPage = () => {
    return (
        <Routes>
            ...
            <Route path={routing.ROUTING_COMMON_DEALER_HIERARCHY} element={<DealerHierarchy /> } />
