...
import { SVGComponent as MoreEllepsislcon } from '@Icons/MoreEllepsisIcon';
...
describe('Icons Components', () => {
    ...
    it('should render MoreEllepsislcon icon component', async () => {
        const moreEllepsislcon = render(<MoreEllepsislcon />);
        expect(moreEllepsislcon).toMatchSnapshot();
    });
});
