...
describe('List Role Master add edit form components', () => {
    ...
    it('Should render role master add edit form components', () => {
        ...
        const divisionData = [
            { key: 1, value: 'test', parentKey: 'test' },
            { key: 2, value: 'test1', parentKey: 'test' },
        ];
        ...
        customRender(
            <Provider store={mockStore}>
                <FormWrapper {...props} isVisible={true} divisionData={divisionData} filteredDepartmentData={filteredDepartmentData} fetchList={fetchList} fetchDivisionLovList={fetchDivisionLovList} fetchDepartmentLovList={fetchDepartmentLovList} formData={formData} />
            </Provider>
        );
