...
describe('Role Master components', () => {
    it('Should render Role Master Applied Advance Filter components', () => {
        ...
        customRender(
            <Provider store={mockStore}>
                <ListRoleMaster isVisible={true} {...props} fetchList={fetchList} fetchDivisionLovList={fetchDivisionLovList} fetchDepartmentLovList={fetchDepartmentLovList} />
            </Provider>
        );
    ...
    it('filter button should work', async () => {
        ...
        const clearBtn = screen.getByTestId('advanceFiltersBtn');
        fireEvent.click(clearBtn);
    ...
    it('refresh button should work', async () => {
        ...
        customRender(
            <Provider store={mockStore}>
                <ListRoleMaster isVisible={true} {...props} fetchList={fetchList} />
            </Provider>
        );
        await waitFor(() => {
    ...
    it('Should render add edit form save button', () => {
        ...
        customRender(
            <Provider store={mockStore}>
                <ListRoleMaster isVisible={true} {...props} fetchList={fetchList} fetchDivisionLovList={fetchDivisionLovList} fetchDepartmentLovList={fetchDepartmentLovList} setIsFormVisible={jest.fn()} handleButtonClick={jest.fn()} resetData={jest.fn()} buttonData={buttonData} setButtonData={jest.fn()} />
            </Provider>
        );
        ...
        const saveAddNewBtn = screen.getByTestId('save-and-new');
    ...
    it('Should render filter button', () => {
        ...
        customRender(
            <Provider store={mockStore}>
                <ListRoleMaster isVisible={true} fetchList={fetchList} fetchDivisionLovList={fetchDivisionLovList} fetchDepartmentLovList={fetchDepartmentLovList} data={'test'} userId={'test'} setFilterString={setFilterString} filterString={filterString} extraParams={extraParams} />
            </Provider>
        );
