...
describe('Vehicle Invoice Master component render', () => {
    ...
    it('irn generation should work', async () => {
        ...
        await waitFor(() => { expect(screen.getByText(/106/i)).toBeInTheDocument(); });
        ...
        const submitGenerate=screen.getByRole('button', { name: 'Submit' });
        fireEvent.click(submitGenerate);
    ...
    it('should render all components', async () => {
        ...
        const nextBtn6=screen.getByRole('button', { name: 'Next' });
    ...
    it('query buttons should work', async () => {
        ...
        const cancellationReq=screen.getByRole('button', { name: 'Cancellation Request' });
        fireEvent.click(cancellationReq);
    ...
    it('cancel invoice should work', async () => {
        ...
        customRender(
            <Provider store={mockStore}>
                <VehicleInvoiceMaster fetchList={fetchList} cancelInvoice={cancelInvoice} />
            </Provider>
        );
