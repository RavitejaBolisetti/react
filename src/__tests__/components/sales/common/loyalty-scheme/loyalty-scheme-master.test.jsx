...
describe('Loyalty scheme master render', () => {
    ...
    it('should render loyalty scheme submit', async () => {
        ...
        customRender(
            <Provider store={mockStore}>
                <FormWrapper StatusBar={StatusBar} onFinishCustom={true} setformData={jest.fn()} saveData={saveData} FormActionButton={FormActionButton} fetchList={fetchList} handleButtonClick={jest.fn()} resetData={jest.fn()} fetchCustomerList={jest.fn()} />
            </Provider>
        );
    ...
    it('Should render view component', () => {
        ...
        const fetchList = jest.fn();
        <FormWrapper StatusBar={StatusBar} FormActionButton={FormActionButton} fetchList={fetchList} formActionType={formActionType} />;
    });
});
