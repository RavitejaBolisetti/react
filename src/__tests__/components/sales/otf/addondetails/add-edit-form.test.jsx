...
describe('Add Edit Form Component', () => {
    it('should render add edit form components', () => {
        customRender(<AddEditForm setformDataSetter={jest.fn()} setFormDataSetter={jest.fn()} />);
    });
    ...
    it('collapse should work', () => {
        ...
        render(<FormWrapper handleCollapse={jest.fn()} setFormDataSetter={jest.fn()} formData={formData} setformDataSetter={jest.fn()} />);
