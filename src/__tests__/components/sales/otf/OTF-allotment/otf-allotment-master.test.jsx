    ...
    it('allot should work', async () => {
      ...
      customRender(
          <Provider store={mockStore}>
              <OTFAllotmentMaster isVisible={true} fetchVehicleAllotmentSearchedList={fetchVehicleAllotmentSearchedList} saveData={saveData} setFilterString={jest.fn()} selectedOrder={selectedOrder} setIsAllotVisible={jest.fn()} setIsFormVisible={jest.fn()} setRefreshData={jest.fn()} />
          </Provider>
      );
      ...
      await waitFor(() => { expect(screen.getByText('PDI Indicator Done')).toBeInTheDocument() });
