...
const buttonData = { cancelBtn: true, closeBtn: true, deliveryNote: true, editBtn: true, formBtnActive: true, saveAndNewBtn: true, saveAndNewBtnClicked: true, saveBtn: true };
...
describe('Term Condition Manufacturer vehicle addedit components', () => {
    it('should render components', () => {
        customRender(<AddEditForm isVisible={true} formData={formData} setFinalData={jest.fn()} buttonData={buttonData} setButtonData={jest.fn()} vehicleStatusType={vehicleStatusType} physicalStatusType={physicalStatusType} shortageType={shortageType} />);
