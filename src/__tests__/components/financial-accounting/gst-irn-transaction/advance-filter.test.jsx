...
import AdvanceFilter from 'components/FinancialAccounting/GstIRNTransaction/AdvanceFilter';
...
describe("AdvanceFilter", ()=>{
    ...
    it("clearBtn", ()=>{
        ...
        const extraParams = [{filter: true, name:'INV22C000617'}];
    ...
    it("removeBtn", ()=>{
        const filterString = {advanceFilter:true};
        const extraParams = [{filter: true, name:'INV22C000617', value:'123', canRemove:'true'}];
