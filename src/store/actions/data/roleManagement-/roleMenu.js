...
import { BASE_URL_ROLE_MANAGEMENT_ROLES_MENU as baseURL } from 'constants/routingApi';

const PREFIX = 'ROLE_MENU_';
const moduleName = 'Role management';
...
export const RoleManagementMenuDataActions = dataActions({
    baseURL,
    moduleName,
