...
import { BASE_URL_AMC_SCHEME_CATEGORY_LOV as baseURL } from 'constants/routingApi';

const PREFIX = 'AMC_SCHEME_CATEGORY_LOV_';
const moduleName = 'AMC Scheme Category';
...
export const amcSchemeCategoryDataAction = dataActions({
    baseURL,
    moduleName,
