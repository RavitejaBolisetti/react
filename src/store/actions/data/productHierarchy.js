...
export const PRODUCT_HIERARCHY_FILTERED_RESET_DATA = 'PRODUCT_HIERARCHY_FILTERED_RESET_DATA';
...
productHierarchyDataActions.resetFilteredData = (data) => ({
    type: PRODUCT_HIERARCHY_FILTERED_RESET_DATA,
    data,
});
