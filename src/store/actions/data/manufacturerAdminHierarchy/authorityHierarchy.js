...
import { BASE_URL_MANUFACTURER_AUTHORITY_TYPE_DROPDOWN as baseURL } from 'constants/routingApi';

const PREFIX = 'MANUFACTURER_ADMIN_ADMIN_AUTHORITY';
...
export const AuthorityHierarchyDataActions = dataActions({
    baseURL,
    moduleName,
