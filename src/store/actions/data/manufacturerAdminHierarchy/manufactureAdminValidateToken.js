...
import { BASE_URL_MANUFACTURER_ADMIN_HIERARCHY_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'MANUFACTURER_ADMIN_VALIDATE_tOKEN';
...
export const ManufactureAdminValidateToken = dataActions({
    baseURL,
    moduleName,
