...
import { BASE_URL_MANUFACTURER_ADMINISTRATION_HIERARCHY as baseURL } from 'constants/routingApi';

const PREFIX = 'MANUFACTURER_ADMIN_HIERARCHY_DETAIL_DATA_';
...
export const ManufacturerAdminHierarchyDetailDataActions = dataActions({
    baseURL,
    moduleName,
