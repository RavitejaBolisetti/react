...
import { BASE_URL_MANUFACTURER_ADMIN_HIERARCHY_CHANGE_HISTORY as baseURL } from 'constants/routingApi';

const PREFIX = 'MANUFACTURER_ADMIN_HIERARCHY_CHANGE_HISTORY_';
const moduleName = 'Manufactuer Admin Hierarchy';
...
export const ManufacturerAdminHierarchyChangeHistoryDataActions = dataActions({
    baseURL,
    moduleName,
