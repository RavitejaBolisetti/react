...
import { BASE_URL_VEHICLE_INVOICE_DETAIL as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_INVOICE_DETAIL_';
const moduleName = 'Vehicle Invoice Detail';
...
export const vehicleDetailsDataActions = dataActions({
    baseURL,
    moduleName,
