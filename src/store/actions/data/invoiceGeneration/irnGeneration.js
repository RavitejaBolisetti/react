...
import { BASE_URL_VEHICLE_IRN_GENERATION as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_IRN_GENERATION_';
const moduleName = 'Vehicle IRN Generation';
...
export const vehicleIrnGenerationDataActions = dataActions({
    baseURL,
    moduleName,
