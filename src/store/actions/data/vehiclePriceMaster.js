...
import { BASE_URL_VEHICLE_PRICE_MASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_PRICE_MASTER';
const moduleName = 'Vehicle Price';
...
export const vehiclePriceMasterDataAction = dataActions({
    baseURL,
    moduleName,
