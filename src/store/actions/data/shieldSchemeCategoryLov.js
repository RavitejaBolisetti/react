...
import { BASE_URL_SHIELD_SCHEME_CATEGORY_LOV as baseURL } from 'constants/routingApi';

const PREFIX = 'SHIELD_SCHEME_CATEGORY_LOV_';
const moduleName = 'Shield Scheme Category';
...
export const shieldSchemeCategoryDataAction = dataActions({
    baseURL,
    moduleName,
