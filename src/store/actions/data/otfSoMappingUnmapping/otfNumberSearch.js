...
import { BASE_URL_SO_MAPPING_OTF_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_SO_MAPPING_OTF_SEARCH';
...
export const otfSoMappingSearchDataActions = dataActions({
    baseURL,
    moduleName,
