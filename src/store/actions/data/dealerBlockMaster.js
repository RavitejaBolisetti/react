...
import { BASE_URL_DEALER_OTF_BLOCK_MASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'DEALER_BLOCK_MASTER';
const moduleName = 'Dealer Block Master';
...
export const dealerBlockMasterDataAction = dataActions({
    baseURL,
    moduleName,
