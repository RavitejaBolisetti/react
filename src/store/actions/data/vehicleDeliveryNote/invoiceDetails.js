...
import { BASE_URL_VEHICLE_DELIVERY_NOTE_INVOICE_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'INVOICE_DETAILS_';
const moduleName = 'Invoice Detail';
...
export const invoiceDetailDataActions = dataActions({
    baseURL,
    moduleName,
