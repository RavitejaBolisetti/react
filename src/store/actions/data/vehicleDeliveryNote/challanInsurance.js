...
import { BASE_URL_VEHICLE_CHALLAN_INSURANCE_DETAILS_DELIVERY_NOTE as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_DELIVERY_NOTE_INSURANCE_DETAILS_';
const moduleName = 'Challan Delivey Note Insurance Details';
...
export const insuranceChallanDetailsDataActions = dataActions({
    baseURL,
    moduleName,
