...
import { BASE_URL_RELATIONSHIP_MANAGER as baseURL } from 'constants/routingApi';

const PREFIX = 'RELATIONSHIP_MANAGER_';
const moduleName = 'Relationship Manager';
...
export const relationshipManagerDataActions = dataActions({
    baseURL,
    moduleName,
