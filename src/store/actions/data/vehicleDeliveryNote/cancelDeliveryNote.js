...
import { BASE_URL_VEHICLE_DELIVERY_NOTE_CANCELLATION as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_DELIVERY_NOTE_CANCEL_';
...
export const cancelVehicleDeliveryNoteDataActions = dataActions({
    baseURL,
    moduleName,
