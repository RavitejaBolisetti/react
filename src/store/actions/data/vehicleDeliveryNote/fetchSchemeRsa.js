...
import { BASE_URL_VEHICLE_ADD_ON_SCHEME_RSA_DESCRIPTION as baseURL } from 'constants/routingApi';

const PREFIX = 'SCHEME_DESCRIPTION_RSA_';
...
export const schemeDescriptionRsaDataActions = dataActions({
    baseURL,
    moduleName,
