...
import { BASE_URL_SCHEME_DESCRIPTION_LOV as baseURL } from 'constants/routingApi';

const PREFIX = 'SCHEME_DESCRIPTION_SHIELD_';
...
export const schemeDescriptionShieldDataActions = dataActions({
    baseURL,
    moduleName,
