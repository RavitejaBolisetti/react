...
import { BASE_URL_DELIVERY_NOTE_VEHICLE_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_REGISTRATION_NUMBER_SEARCH_';
const moduleName = 'Vehicle Registration Number Search';
...
export const vehicleRegistrationNumberDataActions = dataActions({
    baseURL,
    moduleName,
