...
import { BASE_URL_VEHICLE_ADD_ON_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_ADD_ON_DETAILS_';
const moduleName = 'Add On Detail';
...
export const vehicleAddOnDetailDataActions = dataActions({
    baseURL,
    moduleName,
