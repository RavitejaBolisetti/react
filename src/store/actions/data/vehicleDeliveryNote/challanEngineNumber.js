...
import { BASE_URL_CHALLAN_ENGINE_NUMBER as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_DELIVERY_NOTE_CHALLAN_ENGINE_NO_';
const moduleName = 'Challan Delivey Note Engine Number';
...
export const enginNumberDataActions = dataActions({
    baseURL,
    moduleName,
