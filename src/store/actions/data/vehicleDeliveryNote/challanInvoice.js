...
import { BASE_URL_VEHICLE_CHALLAN_INVOICE_DETAILS_DELIVERY_NOTE as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_DELIVERY_NOTE_INVOICE_DETAILS_';
const moduleName = 'Challan Delivey Note Invoice Details';
...
export const invoiceDetailsDataActions = dataActions({
    baseURL,
    moduleName,
