...
import { BASE_URL_VEHICLE_INFO_CANCEL_DELIVERY_NOTE as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_DELIVERY_NOTE_INFO_CANCEL_';
const moduleName = 'Cancel Info';
...
export const infoCancelVehicleDeliveryNoteDataActions = dataActions({
    baseURL,
    moduleName,
