...
import { BASE_URL_VEHICLE_CHALLAN_DETAILS_DELIVERY_NOTE as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_DELIVERY_NOTE_CHALLAN_DETAILS_';
const moduleName = 'Vehicle Delivery Challan Details';
...
export const vehicleChallanDetailsDataActions = dataActions({
    baseURL,
    moduleName,
