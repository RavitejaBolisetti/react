...
import { BASE_URL_VEHICLE_ADD_ON_SCHEME_AMC_DESCRIPTION as baseURL } from 'constants/routingApi';

const PREFIX = 'SCHEME_DESCRIPTION_AMC_';
...
export const schemeDescriptionAmcDataActions = dataActions({
    baseURL,
    moduleName,
