...
import { BASE_URL_VIEW_VEHICLE_PURCHASE_ORDER_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'VIEW_VEHICLE_PURCHASE_ORDR_DETAILS_';
const moduleName = 'View_vehicle Purchase Order Details';
...
export const viewVPODataActions = dataActions({
    baseURL,
    moduleName,
