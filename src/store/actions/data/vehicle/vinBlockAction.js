...
import { BASE_URL_VIN_BLOCK_VIEWMASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'VIN_BLOCK_VIEW_MASTER_DETAILS_';
const moduleName = 'Vin Block View Master Details';
...
export const vinBlockAction = dataActions({
    baseURL,
    moduleName,
