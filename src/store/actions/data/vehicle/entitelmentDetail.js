...
import { BASE_URL_VEHICLE_ENTITELMENT as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_ENTITELMENT_';
const moduleName = 'Vehicle Entitelment & Scheme Details';
...
export const entitelmentDetailDataActions = dataActions({
    baseURL,
    moduleName,
