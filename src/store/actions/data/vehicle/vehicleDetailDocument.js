...
import { BASE_URL_VEHICLE_DETAILS_DOCUMENT as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_DETAILS_DOCUMENT_';
const moduleName = 'VEHICLE Details';
...
export const vehicleDetailDocumentDataActions = dataActions({
    baseURL,
    moduleName,
