...
import { BASE_URL_VEHICLE_PRODUCT_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_PRODUCT_DETAILS_';
const moduleName = 'Vehicle Product Details';
...
export const productDetailsDataActions = dataActions({
    baseURL,
    moduleName,
