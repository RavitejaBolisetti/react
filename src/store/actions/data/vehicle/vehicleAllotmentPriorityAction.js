...
import { BASE_URL_GET_VEHICLE_ALLOTMENT_PRIORITY as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_ALLOTMENT_PRIORITY_DETAILS_';
const moduleName = 'vehicle Alotment Priority Details';
...
export const vehicleAllotPriorityActions = dataActions({
    baseURL,
    moduleName,
