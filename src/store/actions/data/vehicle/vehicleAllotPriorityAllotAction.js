...
import { BASE_URL_VEHICLE_ALLOTMENT_PRIORITY as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_ALLOTMENT_PRIORITY_SAVE_DETAILS_';
const moduleName = 'vehicle Alotment Priority Save Details';
...
export const vehicleAllotPrioritySaveActions = dataActions({
    baseURL,
    moduleName,
