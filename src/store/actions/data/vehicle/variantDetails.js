...
import { BASE_URL_VEHICLE_VARIANT as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_VARIANT_';
const moduleName = 'Vehicle Variant Details';
...
export const vehicleVariantDetailsDataActions = dataActions({
    baseURL,
    moduleName,
