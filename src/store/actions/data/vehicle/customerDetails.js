...
import { BASE_URL_VEHICLE_CUSTOMER_DETAIL as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_CUSTOMER_DETAILS_';
const moduleName = 'Vehicle Customer Details';
...
export const vehicleCustomerDetailsDataAction = dataActions({
    baseURL,
    moduleName,
