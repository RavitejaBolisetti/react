...
import { BASE_URL_VIN_BLOCK_MASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'VIN_BLOCK_MASTER_DETAILS_';
const moduleName = 'Vin Block Master Details';
...
export const vinBlockMasterAction = dataActions({
    baseURL,
    moduleName,
