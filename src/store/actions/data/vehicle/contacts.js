...
import { BASE_URL_VEHICLE_CONTACTS as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_CONTACTS_';
const moduleName = 'Vehicle Contact Details';
...
export const vehicleContactDataActions = dataActions({
    baseURL,
    moduleName,
