...
import { BASE_URL_ON_ROAD_PRICE_MASTER_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'ONROAD_PRICE_MASTER_DETAILS_';
const moduleName = 'Onroad Price Master Details';
...
export const onRoadPriceMasterAction = dataActions({
    baseURL,
    moduleName,
