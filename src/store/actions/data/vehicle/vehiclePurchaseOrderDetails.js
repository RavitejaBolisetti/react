...
import { BASE_URL_VEHICLE_PURCHASE_ORDER_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_PURCHASE_ORDR_DETAILS_';
...
export const vehiclePurchaseOrderDataActions = dataActions({
    baseURL,
    moduleName,
