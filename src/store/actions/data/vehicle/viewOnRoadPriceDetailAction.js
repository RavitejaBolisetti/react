...
import { BASE_URL_VIEWON_ROAD_PRICE_MASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'VIEW_ONROAD_PRICE_MASTER_DETAILS_';
const moduleName = 'View Onroad Price Master Details';
...
export const viewOnRoadPriceDetailAction = dataActions({
    baseURL,
    moduleName,
