...
import { BASE_URL_AREA_OFFICE as baseURL } from 'constants/routingApi';

const PREFIX = 'AREA_OFFICE_';
const moduleName = 'Area Office';
...
export const areaOfficeDataAction = dataActions({
    baseURL,
    moduleName,
