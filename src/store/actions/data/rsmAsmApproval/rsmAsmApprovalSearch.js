...
import { BASE_URL_RSM_ASM_APPROVAL_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'RSM_ASM_APPROVAL_';
const moduleName = 'RSM ASM Approval';
...
export const rsmAsmApprovalSearchDataAction = dataActions({
    baseURL,
    moduleName,
