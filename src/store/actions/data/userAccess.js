...
import { BASE_URL_USER_ACCESS as baseURL } from 'constants/routingApi';

const PREFIX = 'USER_ACCESS';
const moduleName = 'User Access';
...
export const userAccessMasterDataAction = dataActions({
    baseURL,
    moduleName,
