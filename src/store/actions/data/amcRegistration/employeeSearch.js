...
import { BASE_URL_AMC_EMPLOYEE_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'AMC_EMPLOYEE_SEARCH';
const moduleName = 'AMC Employee Search';
...
export const employeeSearchDataAction = dataActions({
    baseURL,
    moduleName,
