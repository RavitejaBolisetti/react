...
import { BASE_URL_AMC_REGISTRATION_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'AMC_REGISTRATION_';
const moduleName = 'AMC Registration';
...
export const amcRegistrationDataAction = dataActions({
    baseURL,
    moduleName,
