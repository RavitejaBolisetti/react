...
import { BASE_URL_DEALER_LOCATIONS as baseURL } from 'constants/routingApi';

const PREFIX = 'AMC_DEALER_LOCATION_';
const moduleName = 'AMC Scheme';
...
export const dealerLocationsDataAction = dataActions({
    baseURL,
    moduleName,
