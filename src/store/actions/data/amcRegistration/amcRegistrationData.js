...
import { BASE_URL_AMC_REGISTRATION_DATA as baseURL } from 'constants/routingApi';

const PREFIX = 'AMC_REGISTRATION_VIEW';
const moduleName = 'AMC Registration View';
...
export const amcRegistrationViewDataAction = dataActions({
    baseURL,
    moduleName,
