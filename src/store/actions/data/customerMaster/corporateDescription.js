...
import { BASE_URL_CORPORATE_DESCRIPTION as baseURL } from 'constants/routingApi';

const PREFIX = 'COMPANY_CORPORATE_DESCRIPTION_';
const moduleName = 'Company Description';
...
export const corporateCompanyDescriptionDataActions = dataActions({
    baseURL,
    moduleName,
