...
import { BASE_URL_CUSTOMER_MASTER_CORPORATE_PARENT_COMPANY as baseURL } from 'constants/routingApi';

const PREFIX = 'CUSTOMER_MASTER_CORPORATE_PARENT_COMPANY_';
const moduleName = 'Customer Details';
...
export const customerParentCompanyDataActions = dataActions({
    baseURL,
    moduleName,
