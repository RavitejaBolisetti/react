...
import { BASE_URL_CUSTOMER_MASTER_CUSTOMER_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'CUSTOMER_MASTER_CUSTOMER_DETAILS_';
...
export const customerDetailsDataActions = dataActions({
    baseURL,
    moduleName,
