...
import { BASE_URL_CUSTOMER_MASTER_ACCOUNTS_RELATED_INDIVISUAL as baseURL } from 'constants/routingApi';

const PREFIX = 'CUSTOMER_MASTER_INDIVISUAL_ACCOUNTS_RELATED_';
const moduleName = 'Accounts Related';
...
export const indivisualAccountsRelatedDataActions = dataActions({
    baseURL,
    moduleName,
