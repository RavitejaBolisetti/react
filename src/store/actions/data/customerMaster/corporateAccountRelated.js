...
import { BASE_URL_CUSTOMER_MASTER_ACCOUNTS_RELATED_CORPORATE as baseURL } from 'constants/routingApi';

const PREFIX = 'CUSTOMER_MASTER_ACCOUNTS_RELATED_';
...
export const corporateAccountsRelatedDataActions = dataActions({
    baseURL,
    moduleName,
