...
import { BASE_URL_CUSTOMER_VERIFY as baseURL } from 'constants/routingApi';

const PREFIX = 'CUSTOMER_VERIFICATION_';
const moduleName = 'Customer Verification';
...
export const customerVerificationtDataActions = dataActions({
    baseURL,
    moduleName,
