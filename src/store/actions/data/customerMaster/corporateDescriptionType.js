...
import { BASE_URL_CORPORATE_TYPE as baseURL } from 'constants/routingApi';

const PREFIX = 'COMPANY_DESCRIPTION_TYPE_';
const moduleName = 'Company Description Type';
...
export const corporateCompanyDescriptionTypeDataActions = dataActions({
    baseURL,
    moduleName,
