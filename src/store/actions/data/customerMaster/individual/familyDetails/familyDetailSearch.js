...
import { BASE_URL_FAMILY_DETAIL_SEARCH } from 'constants/routingApi';
...
const baseURL = BASE_URL_FAMILY_DETAIL_SEARCH;

export const familyDetailSearchDataActions = dataActions({
    baseURL,
