...
import { BASE_URL_CORPORATE_COMPANY_LIST as baseURL } from 'constants/routingApi';

const PREFIX = 'CUSTOMER_MASTER_CORPORATE_';
const moduleName = 'Company List';
...
export const corporateDataActions = dataActions({
    baseURL,
    moduleName,
