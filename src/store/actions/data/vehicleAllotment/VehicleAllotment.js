...
import { BASE_URL_VEHICLE_ALLOTMENT as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_ALLOTMENT';
const moduleName = 'Vehicle Allotment';
...
export const vehicleAllotment = dataActions({
    baseURL,
    moduleName,
