...
import { BASE_URL_DASHBOARD_BILLING_STATICS as baseURL } from 'constants/routingApi';

const PREFIX = 'DASHBOARD_BILLING_';
...
export const billingDataActions = dataActions({
    baseURL,
    moduleName,
