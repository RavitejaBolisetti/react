...
import { BASE_URL_EVR_DETAILS_CAPTURING_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'EVR_DETAILS_CAPTURING_SEARCH_';
const moduleName = 'Evr Details Capturing';
...
export const evrDetailsCapturingDataActions = dataActions({
    baseURL,
    moduleName,
