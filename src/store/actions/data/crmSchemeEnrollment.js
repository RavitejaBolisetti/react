...
import { BASE_URL_CRM_SCHEME_ENROLLMENT as baseURL } from 'constants/routingApi';

const PREFIX = 'CRM_ECHEME_ENROLLMENT';
const moduleName = 'CRM Scheme Search';
...
export const crmSchemeEnrollmentDataActions = dataActions({
    baseURL,
    moduleName,
