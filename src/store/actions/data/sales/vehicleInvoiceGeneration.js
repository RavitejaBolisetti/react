...
import { BASE_URL_VEHICLE_INVOICE as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_INVOICE_';
const moduleName = 'Vehicle Invoice';
...
export const RECEIVE_DETAIL_DATA_LOADING_ACTION_CONSTANT = PREFIX + 'LOADING_DETAIL_DATA';
...
export const vehicleInvoiceGenerationDataActions = dataActions({
    baseURL,
    moduleName,
