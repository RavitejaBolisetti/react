...
import { BASE_URL_RSA_REGISTRATION_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'RSA_REGISTRATION_';
const moduleName = 'RSA Registration';
...
export const rsaRegistrationDataAction = dataActions({
    baseURL,
    moduleName,
