...
import { BASE_URL_RSM_APPROVAL_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'RSM_APPROVAL_SEARCH_';
const moduleName = 'RSM Search';
...
export const rsmApprovalSearchDataAction = dataActions({
    baseURL,
    moduleName,
