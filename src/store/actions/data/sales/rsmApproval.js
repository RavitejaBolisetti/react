...
import { BASE_URL_RSM_APPROVAL as baseURL } from 'constants/routingApi';

const PREFIX = 'RSM_APPROVAL_';
const moduleName = 'RSM Approval';
...
export const rsmApprovalDataAction = dataActions({
    baseURL,
    moduleName,
