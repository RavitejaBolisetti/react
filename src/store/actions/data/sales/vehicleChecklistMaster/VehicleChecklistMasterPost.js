...
import { BASE_URL_VEHICLE_CHECKLIST_MASTER_GROUP as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_CHECKLIST_MASTER_POST_';
...
export const vehicleChecklistMasterPostDataActions = dataActions({
    baseURL,
    moduleName,
