...
import { BASE_URL_VEHICLE_CHECKLIST_MASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_CHECKLIST_MASTER_';
...
export const vehicleChecklistMasterDataActions = dataActions({
    baseURL,
    moduleName,
