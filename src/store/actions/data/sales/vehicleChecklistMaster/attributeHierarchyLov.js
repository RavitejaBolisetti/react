...
import { BASE_URL_HIERARCHY_ATTRIBUTE_LOV as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_CHECKLIST_MASTER_ATTRIBUTE_LOV_';
const moduleName = 'Vehicle Checklist Master';
...
export const vehicleChecklistMasterAttributeLovDataActions = dataActions({
    baseURL,
    moduleName,
