...
import { BASE_URL_VEHICLE_TRACKING as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_TRACKING_';
const moduleName = 'Vehicle Tracking';
...
export const vehicleTrackingDataActions = dataActions({
    baseURL,
    moduleName,
