...
import { BASE_URL_STOCK_TRANSFER_INDENT_ISSUE as baseURL } from 'constants/routingApi';

const PREFIX = 'STOCK_TRANSFER_INDENT_ISSUE';
...
export const StockIndentIssueDataAction = dataActions({
    baseURL,
    moduleName,
