...
import { BASE_URL_DELIVERY_NOTE_INVOICE_CANCELLATION as baseURL } from 'constants/routingApi';

const PREFIX = 'INVOICE_CANCELLATION_';
const moduleName = 'Invoice Cancellation';
...
export const deliveryNoteInvoiceCancellationDataAction = dataActions({
    baseURL,
    moduleName,
