...
import { BASE_URL_VEHICLE_MODEL_AND_TAX_CHARGE_CATEGORY_PRODUCT_MODEL_GROUP as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_MODEL_AND_TAX_CHARGES_CATEGORY_MODEL_GROUP_';
const moduleName = 'Product Model Groups';
...
export const ProductModelGroupsDataActions = dataActions({
    baseURL,
    moduleName,
