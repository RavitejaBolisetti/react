...
import { BASE_URL_VEHICLE_MODEL_AND_TAX_CHARGE_CATEGORY as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_AND_TAX_CHARGES_CATEGORY_';
const moduleName = 'Vehicle Model and Tax Charges';
...
export const VehicleTaxChargesDataActions = dataActions({
    baseURL,
    moduleName,
