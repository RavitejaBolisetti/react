...
import { BASE_URL_VEHICLE_MODEL_AND_TAX_CHARGE_CATEGORY_ACCOUNT_CATEGORY as baseURL } from 'constants/routingApi';

const PREFIX = 'ACCOUNT_CATEGORY_LOV_';
const moduleName = 'ACCOUNT CATEGORY';
...
export const AccountCategoryLovdataActions = dataActions({
    baseURL,
    moduleName,
