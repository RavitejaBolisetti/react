...
import { BASE_URL_VEHICLE_MODEL_AND_TAX_CHARGE_CATEGORY_TAX_CHARGES as baseURL } from 'constants/routingApi';

const PREFIX = 'TAX_CHARGE_CATEGORY_LOV_';
const moduleName = 'TAX CHARGE CATEGORY LOV';
...
export const TaxChargesLovdataActions = dataActions({
    baseURL,
    moduleName,
