...
import { BASE_URL_VEHICLE_SALES_SCHEME_MASTER_UPLOAD as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_SALES_SCHEME_MASTER_UPLOAD';
...
export const vehicleSalesSchemeMasterUpload = dataActions({
    baseURL,
    moduleName,
