...
import { BASE_URL_VEHICLE_CUSTOMER_CRM_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'CRM_CUSTOMER_VEHICLE_';
const moduleName = 'CRM Customer Vehicle';
...
export const crmCustomerVehicleDataActions = dataActions({
    baseURL,
    moduleName,
