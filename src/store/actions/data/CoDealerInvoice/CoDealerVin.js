...
import { BASE_URL_CO_DEALER_VIN_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'CO_DEALER_INVOICE_VIN_';
const moduleName = 'Co Dealer Invoice VIN';
...
export const CoDealerVinNumberDataActions = dataActions({
    baseURL,
    moduleName,
