...
import { BASE_URL_MANUFACTURER_ORGANIZATION_HIERARCHY as baseURL } from 'constants/routingApi';

const PREFIX = 'MANUFACTURER_ORG_HIERARCHY_';
...
export const ManufacturerOrgHierarchyDataActions = dataActions({
    baseURL,
    moduleName,
