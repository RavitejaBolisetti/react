...
import { BASE_URL_MANUFACTURER_ADMIN_AUTHORITY_CHANGE_HISTORY as baseURL } from 'constants/routingApi';

const PREFIX = 'MANUFACTURER_ORG_HIERARCHY_CHANGE_HISTORY_';
const moduleName = 'Manufactuer Organization Hierarchy';
...
export const ManufacturerOrgHierarchyChangeHistoryDataActions = dataActions({
    baseURL,
    moduleName,
