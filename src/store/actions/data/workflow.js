...
import { BASE_URL_WORK_FLOW_MASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'WORK_FLOW';
const moduleName = 'Work Flow';
...
export const workFlowDataAction = dataActions({
    baseURL,
    moduleName,
