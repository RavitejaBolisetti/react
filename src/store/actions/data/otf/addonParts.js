...
import { BASE_URL_ADD_ON_PART as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_ADD_ON_PARTS_';
const moduleName = 'Add On Parts';
...
export const otfAddOnPartsDataActions = dataActions({
    baseURL,
    moduleName,
