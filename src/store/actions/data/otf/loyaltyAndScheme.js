...
import { BASE_URL_LOYALTY_AND_SCHEME as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_LOYALTY_SCEHME_';
const moduleName = 'Loyalty Scheme';
...
export const otfLoyaltySchemeDataActions = dataActions({
    baseURL,
    moduleName,
