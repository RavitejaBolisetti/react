...
import { BASE_URL_ADD_ON_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_ADD_ON_DETAILS_';
const moduleName = 'Add On Details';
...
export const otfAddOnDetailsDataActions = dataActions({
    baseURL,
    moduleName,
