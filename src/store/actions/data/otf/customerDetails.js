...
import { BASE_URL_OTF_CUSTOMER as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_CUSTOMER_DETAILS_';
const moduleName = 'Booking Customer Details';
...
export const otfCustomerDetailsAction = dataActions({
    baseURL,
    moduleName,
