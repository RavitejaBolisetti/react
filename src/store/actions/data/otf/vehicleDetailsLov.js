...
import { BASE_URL_PRODUCT_HIERARCHY as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_VEHICLE_DETAILS_LOV_';
...
export const otfvehicleDetailsLovDataActions = dataActions({
    baseURL,
    moduleName,
