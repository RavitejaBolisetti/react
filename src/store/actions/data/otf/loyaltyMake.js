...
import { BASE_URL_PRODUCT_MAKE as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_LOYALTY_MAKE_';
const moduleName = 'Loyalty Make';
...
export const otfLoyaltyMakeDetailDataActions = dataActions({
    baseURL,
    moduleName,
