...
import { BASE_URL_PRODUCT_VARIENT as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_LOYALTY_VARIENT_';
const moduleName = 'Loyalty Varient';
...
export const otfLoyaltyVarientDetailDataActions = dataActions({
    baseURL,
    moduleName,
