...
import { BASE_URL_OTF_CANCELLATION as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_CANCELLATION_';
const moduleName = 'OTF Cancellation';
...
export const cancellationDataActions = dataActions({
    baseURL,
    moduleName,
