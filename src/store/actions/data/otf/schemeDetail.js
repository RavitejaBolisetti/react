...
import { BASE_URL_OTF_SCHEME_DETAIL as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_SCHEME_DETAILS_';
const moduleName = 'Scheme And Offer Details';
...
export const otfSchemeDetailDataActions = dataActions({
    baseURL,
    moduleName,
