...
import { BASE_URL_OTF_SCHEMES as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_SCHEME_';
const moduleName = 'Scheme Detail';
...
export const schemeDataActions = dataActions({
    baseURL,
    moduleName,
