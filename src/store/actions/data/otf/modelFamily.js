...
import { BASE_URL_PRODUCT_MODEL_FAMILY as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_PRODUCT_MODEL_FAMILY_';
const moduleName = 'Model Family';
...
export const otfModelFamilyDetailDataActions = dataActions({
    baseURL,
    moduleName,
