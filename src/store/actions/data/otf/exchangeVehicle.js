...
import { BASE_URL_OTF_EXCHANGE_VEHICLE as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_EXCHANGE_VEHICLE_';
...
export const otfExchangeVehicleDataActions = dataActions({
    baseURL,
    moduleName,
