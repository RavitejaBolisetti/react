...
import { BASE_URL_OTF_TRANSFER as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_TRANSFER_';
const moduleName = 'BOOKING TRANSFER';
...
export const otfTransferActions = dataActions({
    baseURL,
    moduleName,
