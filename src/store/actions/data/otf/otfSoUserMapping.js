...
import { BASE_URL_OTF_SO_USER_MAPPING as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_SO_USER_MAPPING_';
...
export const otfSoUserMappingActions = dataActions({
    baseURL,
    moduleName,
