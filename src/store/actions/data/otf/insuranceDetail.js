...
import { BASE_URL_OTF_INSURANCE_DETAIL as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_INSURANCE_DETAIL_';
const moduleName = 'Insurance Detail';
...
export const insuranceDetailDataActions = dataActions({
    baseURL,
    moduleName,
