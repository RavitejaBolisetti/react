...
import { BASE_URL_PRODUCT_MODEL_GROUP as baseURL } from 'constants/routingApi';

const PREFIX = 'OTF_PRODUCT_MODEL_GROUP_';
const moduleName = 'Loyalty Model Group';
...
export const otfLoyaltyModelGroupDataActions = dataActions({
    baseURL,
    moduleName,
