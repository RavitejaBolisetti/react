...
import { BASE_URL_VEHICLE_SALES_SCHEME_MASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_SALES_SCHEME_MASTER';
const moduleName = 'Vehicle Sales Scheme Master';
...
export const vehicleSalesSchemeMaster = dataActions({
    baseURL,
    moduleName,
