...
import { BASE_URL_FINANCIAL_ACC_CHART_OF_ACCOUNT_EXPORT_COA } from 'constants/routingApi';

const PREFIX = 'CHART_OF_ACCOUNT_MASTER_EXPORT_COA_';
...
const baseURL = BASE_URL_FINANCIAL_ACC_CHART_OF_ACCOUNT_EXPORT_COA;

export const chartOfAccountDataExportCOAActions = dataActions({
    baseURL,
