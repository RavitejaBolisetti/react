...
import { BASE_URL_CREDIT_DEBIT_NOTE_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'CREDIT_DEBIT_SEARCH_';
const moduleName = 'Credit Debit Note Search';
...
export const creditDebitNoteSearchDataAction = dataActions({
    baseURL,
    moduleName,
