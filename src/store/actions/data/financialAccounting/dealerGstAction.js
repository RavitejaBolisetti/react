...
import { BASE_URL_DEALER_GST as baseURL } from 'constants/routingApi';

const PREFIX = 'DEALER_GST_DETAILS_';
const moduleName = 'Dealer Gst Details';
...
export const dealerGstAction = dataActions({
    baseURL,
    moduleName,
