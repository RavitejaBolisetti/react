...
import { BASE_URL_INVOICE_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'INVOICE_DETAILS';
const moduleName = 'Invoice Details';
...
export const invoiceDetailsDataAction = dataActions({
    baseURL,
    moduleName,
