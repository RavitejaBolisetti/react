...
import { BASE_URL_FINANCIAL_ACC_ACCOUNT_CATEGORY } from 'constants/routingApi';

const PREFIX = 'ACCOUNT_CATEGORY_';
...
const baseURL = BASE_URL_FINANCIAL_ACC_ACCOUNT_CATEGORY;

export const accountCategoryDataActions = dataActions({
    baseURL,
