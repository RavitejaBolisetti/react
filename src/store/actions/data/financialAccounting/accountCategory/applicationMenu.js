...
import { BASE_URL_FINANCIAL_ACC_APPLICATION_MENU } from 'constants/routingApi';

const PREFIX = 'APPLICATION_MENU_';
...
const baseURL = BASE_URL_FINANCIAL_ACC_APPLICATION_MENU;

export const applicationMenuDataActions = dataActions({
    baseURL,
