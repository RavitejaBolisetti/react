...
import { BASE_URL_FINANCIAL_ACC_ACCOUNT_CATEGORY_DOCUMENT_DESCRIPTION } from 'constants/routingApi';

const PREFIX = 'ACCOUNT_CATEGORY_DOCUMENT_DESCRIPTION_';
...
const baseURL = BASE_URL_FINANCIAL_ACC_ACCOUNT_CATEGORY_DOCUMENT_DESCRIPTION;

export const accountCategoryDocumentDescriptionDataActions = dataActions({
    baseURL,
    moduleName: 'Account Category',
