...
import { BASE_URL_FINANCIAL_ACC_TAX_CHARGE_CATEGORY } from 'constants/routingApi';
...
const baseURL = BASE_URL_FINANCIAL_ACC_TAX_CHARGE_CATEGORY;

export const taxChargeCategoryDataActions = dataActions({
    baseURL,
