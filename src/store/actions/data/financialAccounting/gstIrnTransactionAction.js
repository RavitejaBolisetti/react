...
import { BASE_URL_MENU as baseURL } from 'constants/routingApi';

const PREFIX = 'DEALER_GST_IRN_TRANSACTION_DETAILS_';
const moduleName = 'Dealer Gst Irn Transaction Details';
...
export const gstIrnTransactionAction = dataActions({
    baseURL,
    moduleName,
