...
import { BASE_URL_GST_LOGIN as baseURL } from 'constants/routingApi';

const PREFIX = 'GST_IRN_LOGIN_DETAILS_';
const moduleName = 'Gst Irn Login Details';
...
export const gstIrnLoginAction = dataActions({
    baseURL,
    moduleName,
