...
import { BASE_URL_DEALER_BRANCH_ACCESS as baseURL } from 'constants/routingApi';

const PREFIX = 'DEALER_BRANCH_DETAILS_';
const moduleName = 'Dealer Branch Details';
...
export const dealerBranchAccessAction = dataActions({
    baseURL,
    moduleName,
