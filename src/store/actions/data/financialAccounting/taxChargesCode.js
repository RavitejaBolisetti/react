...
import { BASE_URL_FINANCIAL_ACC_TAX_CHARGE_CODE } from 'constants/routingApi';

const PREFIX = 'TAX_CHARGES_CODE_';
...
const baseURL = BASE_URL_FINANCIAL_ACC_TAX_CHARGE_CODE;

export const financialAccTaxChargeCategoryDataActions = dataActions({
    baseURL,
