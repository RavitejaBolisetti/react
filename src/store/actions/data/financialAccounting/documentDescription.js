...
import { BASE_URL_DOCUMENT_DESCRIPTION as baseURL} from 'constants/routingApi';

const PREFIX = 'DOCUMENT_DECRIPTION_';
...
export const documentDescriptionDataActions = dataActions({
    baseURL,
    moduleName: 'Document Description',
