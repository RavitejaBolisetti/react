...
import { BASE_URL_GST_DOCID_NAME as baseURL } from 'constants/routingApi';

const PREFIX = 'GST_SELECT_DOC_DETAILS_';
const moduleName = 'Gst Select Doc Details';
...
export const selectGstToDocAction = dataActions({
    baseURL,
    moduleName,
