...
import { BASE_URL_LESSOR_COMPANY_CREATION as baseURL } from 'constants/routingApi';

const PREFIX = 'LESSOR_COMPANY_CREATION_';
const moduleName = 'Lessor Company Creation';
...
export const lessorCompanyCreationDataActions = dataActions({
    baseURL,
    moduleName,
