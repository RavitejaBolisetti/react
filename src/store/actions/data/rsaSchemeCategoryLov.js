...
import { BASE_URL_RSA_SCHEME_CATEGORY_LOV as baseURL } from 'constants/routingApi';

const PREFIX = 'RSA_SCHEME_CATEGORY_LOV_';
const moduleName = 'RSA Scheme Category';
...
export const rsaSchemeCategoryDataAction = dataActions({
    baseURL,
    moduleName,
