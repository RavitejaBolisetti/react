...
import { BASE_URL_USER_MANAGEMENT_USER_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'USER_MANAGEMENTR_SEARCH';
...
export const searchUserDataActions = dataActions({
    baseURL,
    moduleName,
