...
// import { BASE_URL_DEALER_COMPANY_LOV as baseURL } from 'constants/routingApi';
// import { BASE_URL_DEALER_COMAPANY as baseURL } from 'constants/routingApi';
import { BASE_URL_DEALER_LIST as baseURL } from 'constants/routingApi';

const PREFIX = 'USER_MANAGEMENT_DEALER_LIST';
...
export const UserDealerListDataActions = dataActions({
    baseURL,
    moduleName,
