...
import { BASE_URL_USER_MANAGEMENT_MAC_ID as baseURL } from 'constants/routingApi';

const PREFIX = 'USER_MANAGEMENT_MAC_ID';
...
export const MacIdDataActions = dataActions({
    baseURL,
    moduleName,
