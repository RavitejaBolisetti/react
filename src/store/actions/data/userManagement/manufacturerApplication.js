...
import { BASE_URL_USER_MANAGEMENT_MANUFACTURER_APPLICATIONS as baseURL } from 'constants/routingApi';

const PREFIX = 'USER_MANAGEMENT_MNM_APPLICATION';
...
export const ManufacturerAppDataActions = dataActions({
    baseURL,
    moduleName,
