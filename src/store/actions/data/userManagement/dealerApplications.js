...
import { BASE_URL_USER_MANAGEMENT_APPLICATIONS_DEALER as baseURL } from 'constants/routingApi';

const PREFIX = 'USER_MANAGEMENT_DEALER_APPLICATION';
...
export const DealerAppDataActions = dataActions({
    baseURL,
    moduleName,
