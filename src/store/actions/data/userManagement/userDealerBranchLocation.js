...
import { BASE_URL_USER_MANAGEMENT_USER_DEALER_BRANCH_LOCATIONS as baseURL } from 'constants/routingApi';

const PREFIX = 'USER_MANAGEMENT_USER_DEALER_BRANCH_LOCATIONS_';
...
export const UserDealerBranchLocationDataActions = dataActions({
    baseURL,
    moduleName,
