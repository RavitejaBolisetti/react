...
import { BASE_URL_VEHICLE_RECEIPT_CHECKLIST_SUPPORTING_DOCUMENT as baseURL } from 'constants/routingApi';

const PREFIX = 'SUPPORTING_DOCUMENT_';
...
export const ChecklistSupportingDocumentdataActions = dataActions({
    baseURL,
    moduleName,
