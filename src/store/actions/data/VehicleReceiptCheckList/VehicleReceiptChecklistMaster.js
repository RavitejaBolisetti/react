...
import { BASE_URL_VEHICLE_RECEIPT_CHECKLIST_MASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_RECEIPT_CHECKLIST_MASTER';
...
export const VehicleCheclistDetailsdataActions = dataActions({
    baseURL,
    moduleName,
