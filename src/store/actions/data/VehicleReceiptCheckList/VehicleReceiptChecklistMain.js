...
import { BASE_URL_VEHICLE_RECEIPT_CHECKLIST_MAIN as baseURL } from 'constants/routingApi';

const PREFIX = 'VEHICLE_RECEIPT_CHECKLIST_SEARCH';
...
export const vehicleReceiptChecklistdataActions = dataActions({
    baseURL,
    moduleName,
