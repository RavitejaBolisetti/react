...
import { BASE_URL_SHIELD_REGISTRATION_SEARCH as baseURL } from 'constants/routingApi';

const PREFIX = 'SHIELD_SCHEME_REGISTRATION_';
const moduleName = 'Shield Scheme Registration';
...
export const RECEIVE_DETAIL_DATA_LOADING_ACTION_CONSTANT = PREFIX + 'RECEIVE_DETAIL_DATA_LOADING_ACTION_CONSTANT';
...
export const shieldSchemeSearchDataAction = dataActions({
    baseURL,
    moduleName,
