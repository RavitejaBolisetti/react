...
import { BASE_URL_ZONE_MASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'ZONE_MASTER_';
const moduleName = 'Zone Master';
...
export const zoneMasterDataAction = dataActions({
    baseURL,
    moduleName,
