...
import { BASE_URL_LESSOR_CUSTOMER_CREATION as baseURL } from 'constants/routingApi';

const PREFIX = 'LESSOR_CUSTOMER_CREATION_';
const moduleName = 'Lessor Customer Creation';
...
export const lessorCustomerCreationDataActions = dataActions({
    baseURL,
    moduleName,
