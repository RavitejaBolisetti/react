...
import { BASE_URL_RECEIPT_DETAILS as baseURL } from 'constants/routingApi';

const PREFIX = 'RECEIPT_DETAILS_';
const moduleName = 'Receipt Detail';
...
export const receiptDetailDataActions = dataActions({
    baseURL,
    moduleName,
