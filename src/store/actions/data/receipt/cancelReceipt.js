...
import { BASE_URL_CANCEL_RECEIPT as baseURL } from 'constants/routingApi';

const PREFIX = 'CANCEL_RECEIPT_';
const moduleName = 'Cancel Receipt';
...
export const cancelReceiptDataActions = dataActions({
    baseURL,
    moduleName,
