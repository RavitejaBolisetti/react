...
import { BASE_URL_MILE_SKILL as baseURL } from 'constants/routingApi';

const PREFIX = 'DEALER_MANPOWER_MILESKILL_';
const moduleName = 'Dealer ManPower';
...
export const MileSkillDataactions = dataActions({
    baseURL,
    moduleName,
