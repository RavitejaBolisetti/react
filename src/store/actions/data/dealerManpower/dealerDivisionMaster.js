...
import { BASE_URL_DEALER_MANPOWER_DIVISION_MASTER as baseURL } from 'constants/routingApi';

const PREFIX = 'DEALER_MANPOWER_DIVISION_';
const moduleName = 'Division Master';
...
export const dealerManpowerDivisionMasterDataActions = dataActions({
    baseURL,
    moduleName,
