...
import { BASE_URL_DEALER_MANPOWER_BAY_TYPE as baseURL } from 'constants/routingApi';

const PREFIX = 'DEALER_MANPOWER_BAY_TYPE_';
const moduleName = 'Bay Type Master';
...
export const dealerManpowerBayTypeMasterDataActions = dataActions({
    baseURL,
    moduleName,
