...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Approval details';
...
const ApprovalDetailMain = (props) => {
        ...
        <Form layout="vertical" autoComplete="off" form={form} onValuesChange={handleFormValueChange} onFieldsChange={handleFormValueChange} onFinish={onFinish}>
                ...
                <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                    <Row>
                        <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                            {/* <h2>{translateContent('partMaster.section.drawertitle' + section?.id)}</h2> */}
                            <h2>{section?.title}</h2>
                        </Col>
                    </Row>
            ...
            <Row>
                <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                    <VehicleRelatedFormButton {...props} />
                </Col>
            </Row>
        </Form>
    );
};
export const ApprovalDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(ApprovalDetailMain);
