...
export const adminChangeHistory = () => {
    const tableColumnAdmin = [
        tblPrepareColumns({
    ...
    return tableColumnAdmin;
};
export const authorityChangeHistory = () => {
    const tableColumnAuthority = [
        tblPrepareColumns({
            title: translateContent('adminHierarchy.label.changedDate'),
