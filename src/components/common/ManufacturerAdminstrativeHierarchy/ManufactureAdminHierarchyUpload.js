            ...
            <Form autoComplete="off">
                ...
                <Row gutter={20}>
                    <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                            ...
                            <Dragger {...uploadProps} style={{margin:'1.5rem 0 0 0',
                            background: "#F2F2F2",
