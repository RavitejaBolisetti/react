...
export const HierarchyViewMain = ({ viewMode, isLoading, viewTitle, buttonData, manufacturerAdminHierarchyData, documentTypesList, setDocumentTypesList, attributeData, selectedTreeData, handleEditBtn, handleRootChildBtn, handleChildBtn, handleSiblingBtn, setClosePanels, styles }) => {
    const viewProps = {
        bordered: false,
        colon: false,
        layout: 'vertical',
    ...
    console.log('selectedTreeData?.parentName ', selectedTreeData?.parentName);
