...
export const UserManagementFormButton = ({ record, handleChangeHistory, onCloseAction, buttonData, setButtonData, saveButtonName = translateContent('global.buttons.saveCloseBtn'), handleButtonClick, isLoadingOnSave, isLastSection }) => {
    return (
