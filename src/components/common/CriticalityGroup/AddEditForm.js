                        ...
                        <>
                            <Row gutter={20}>
                                <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                    <Form.Item name="criticalityGroupCode" label={translateContent('criticalityGroup.label.criticalityGroupId')} initialValue={formData?.criticalityGroupCode} rules={[validateRequiredInputField('id'), validationFieldLetterAndNumber('id')]}>
                                        <Input maxLength={6} placeholder={preparePlaceholderText('id')} disabled={formActionType?.editMode ? true : false} />
                                    </Form.Item>
                                </Col>
                                <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                    <Form.Item name="criticalityGroupName" label={translateContent('criticalityGroup.label.criticalityGroupName')} initialValue={formData?.criticalityGroupName} rules={[validateRequiredInputField('name'), validateAlphanumericWithSpace('name')]}>
                            ...
                            <Row gutter={20}>
                                <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                    <Form.Item data-testid="default-toggle" initialValue={formActionType?.editMode ? formData?.criticalityDefaultGroup : false} valuePropName="checked" label={translateContent('criticalityGroup.label.defaultGroup')} name="criticalityDefaultGroup" rules={[validateRequiredInputField('Default Group')]}>
                                        <Switch checkedChildren="Active" unCheckedChildren="Inactive" onChange={(checked) => (checked ? 1 : 0)} />
                                    </Form.Item>
                                </Col>

                                <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                    <Form.Item data-testid="toggle" initialValue={formActionType?.editMode ? formData?.activeIndicator : false} valuePropName="checked" label={translateContent('criticalityGroup.label.status')} name="activeIndicator" rules={[validateRequiredInputField('Status')]}>
                                        <Switch checkedChildren="Active" unCheckedChildren="Inactive" onChange={(checked) => (checked ? 1 : 0)} />
                                    </Form.Item>
                                </Col>
                            </Row>
