...
const FormComponent = ({ form, onFinish, isEditing, isBtnDisabled, setIsBtnDisabled }) => {
    ...
    return (
        <Form form={form} id="myFormParent" layout="vertical" onFinish={onFinish} onFinishFailed={onFinishFailed}>
            <Row gutter={20}>
            ...
            {!isEditing && (
                <Button form='myFormParent' disabled={isBtnDisabled} icon={<PlusOutlined />} type="primary" danger htmlType="submit">
                    Add
                </Button>
            )}
        </Form>
