...
describe('manufacturerorghierarchy component', () => {
    ...
    describe('handleAdd', () => {
      ...
      describe('MyComponent', () => {
        ...
        // it('should update isFormBtnActive when setFormBtnActive is called', () => {
        //   // Render the component
        //   const { getByTestId } = render(<ManufacturerOrgHierarchy />);
      
        //   // Find the element with the test ID for the button that updates isFormBtnActive
        //   const setFormBtnActiveBtn = findByTestId('setFormBtnActiveBtn');
      
        //   // Click the button
        //   fireEvent.click(setFormBtnActiveBtn);
      
        //   // Find the element with the test ID for isFormBtnActive
        //   const isFormBtnActiveEl = getByTestId('isFormBtnActive');
      
        //   // Expect the text content to be "true"
        //   expect(isFormBtnActiveEl.textContent).toBe('Change History');
        // });
      });
      jest.mock('axios', () => ({
        fetchList: jest.fn(),
