...
describe('ProductHierarchy component', () => {
    test('render add child button', async () => {
        render(<ProductHierarchy fetchList={fetchList} hierarchyAttributeFetchList={hierarchyAttributeFetchList} />);
    ...
    test('Save form element', async () => {
        ...
        const { getByLabelText, getByText } = render(<ProductHierarchy fetchList={fetchList} onFinish={onFinish} saveData={saveData} hierarchyAttributeFetchList={hierarchyAttributeFetchList} />);
        const RootChildButton = screen.getByText('Add Child');
        fireEvent.click(RootChildButton);
    ...
    test('reset form button', async () => {
        ...
        const { getByLabelText, getByText } = render(<ProductHierarchy handleResetBtn={handleResetBtn} fetchList={fetchList} hierarchyAttributeFetchList={hierarchyAttributeFetchList} />);
    ...
    test('render tree view and click branch to add child after selecting parent', async () => {
        render(<ProductHierarchy fetchList={fetchList} hierarchyAttributeFetchList={hierarchyAttributeFetchList} geoData={treeDatas} />);
