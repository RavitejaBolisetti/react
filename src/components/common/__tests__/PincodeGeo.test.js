...
import { PincodeGeo } from '../Geo/Pincode/PincodeGeo';
...
describe('PIN Master Test', () => {
    test('Is the search Field Present or not', () => {
        render(<PincodeGeo fetchList={fetchList} saveData={saveData} />);
        searchFieldTest()
    });
    ...
    test('Is search working', async () => {
        render(<PincodeGeo qualificationData={qualificationMasterData1} listShowLoading={listShowLoading} fetchList={fetchList} saveData={saveData} />);
