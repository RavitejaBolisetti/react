        ...
        <Card style={{ backgroundColor: '#F2F2F2' }}>
            <div className={styles.viewDrawerContainer}>
                ...
                <Descriptions {...viewProps}>
                    ...
                    {formData?.corporateType === 'NON-LIS' ? <Descriptions.Item label="Corporate Name">{formData?.corporateName}</Descriptions.Item> : <Descriptions.Item label="Corporate Name">{checkAndSetDefaultValue(getCodeValue(corporateLovData, formData?.corporateName), isLoading)}</Descriptions.Item>}
