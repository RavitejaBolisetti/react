...
//                     <Form.Item label="Documents Type" name="documentTypeId" placeholder={preparePlaceholderSelect('document type')}>
...
//                 </Col>
//                 <Col xs={24} sm={24} md={12} lg={12} xl={12}>
//                     <Form.Item label="Files Name swertyuiosss" name="documentName">
