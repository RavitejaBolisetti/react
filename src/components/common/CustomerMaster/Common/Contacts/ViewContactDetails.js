...
import { checkAndSetDefaultValue, getNameFromKey } from 'utils/checkAndSetDefaultValue';
            ...
            {!isEditing ? (
                <>
                    ...
                    <Descriptions {...viewProps}>
                        <Descriptions.Item label="Purpose of Contact">{checkAndSetDefaultValue(getNameFromKey(typeData['PURPOSE'], formData?.purposeOfContact), isLoading)}</Descriptions.Item>
                        ...
                        <Descriptions.Item label="Relation">{checkAndSetDefaultValue(getNameFromKey(typeData['FAMLY_RELTN'], formData?.relationCode ), isLoading)}</Descriptions.Item>
                        <Descriptions.Item label="Gender">{checkAndSetDefaultValue(getNameFromKey(typeData['GENDER_CD'], formData?.gender ), isLoading)}</Descriptions.Item>
                        <Descriptions.Item label="Title">{checkAndSetDefaultValue(getNameFromKey(typeData['TITLE'], formData?.title ), isLoading)}</Descriptions.Item>
