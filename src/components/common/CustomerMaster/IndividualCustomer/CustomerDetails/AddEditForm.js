...
const AddEditFormMain = (props) => {
    const { onCloseAction, form, setIsViewModeVisible,isHtmltype, data,onChange, formActionType:{viewMode,addMode,editMode} = undefined, onFinish, onFinishFailed, onFieldsChange, formActionType, configurableTypedata, formData,handleButtonClick, customerDetailsIndividualData ,corporateLovData,fetchCorporate} = props;
                                    ...
                                    <Row gutter={20}>
                                        ...
                                        <Col xs={24} sm={24} md={8} lg={8} xl={8}>
                                            <Form.Item label="Customer Type" initialValue={formData?.customerType} name="customerType" data-testid="customerType" rules={[validateRequiredSelectField('customer Type')]}>
                                                <Select placeholder="Select" loading={false} allowClear fieldNames={{ label: 'value', value: 'key' }} options={configurableTypedata['CUST_TYPE']} disabled={!editMode ? true : false}></Select>
                                            </Form.Item>
                                        </Col>
                                    </Row>
                                    <Divider />
