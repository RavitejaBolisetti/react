        ...
        <>
            ...
            {seletedAttribute === DEALER_HIERARCHY.PARNT.KEY ?
                <div>
                    <Row gutter={20}>
                        <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                            <Form.Item initialValue={formData?.attributeId} name="parentGroup[0].attributeId" label="Attribute Level" rules={[validateRequiredSelectField('Attribute Level')]}>
                                <Select loading={!isDataAttributeLoaded} placeholder="Select" {...disabledProps} onChange={handleChange} showSearch allowClear>
                                    {attributeData?.map((item) => (
                                        <Option value={item?.hierarchyAttribueId}>{item?.hierarchyAttribueName}</Option>
                                    ))}
                        ...
                        <Col xs={24} sm={12} md={12} lg={12} xl={12} className={styles.padRight18}>
                            <Form.Item initialValue={treeCodeId} label="Parent" placeholder="Please Select" name="parentGroup[0].dealerParentCode">
                                <TreeSelect
                                    treeLine={true}
                                    treeIcon={true}
                                    onChange={handleSelectTreeClick}
                    ...
                    <Row gutter={20}>
                        <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                            <Form.Item initialValue={formData?.code} label="Code" name="parentGroup[0].code" rules={[validateRequiredInputField('Code'), validationFieldLetterAndNumber('Code')]}>
                                <Input placeholder="Code" maxLength={6} className={styles.inputBox} disabled={formData?.id || isReadOnly} />
                            </Form.Item>
                        </Col>

                        <Col xs={24} sm={12} md={12} lg={12} xl={12} className={styles.padRight18}>
                            <Form.Item initialValue={formData?.shortDescription} label="Short Description" name="parentGroup[0].shortDescription" rules={[validateRequiredInputField('Name')]}>
                                <Input placeholder="Enter Data" className={styles.inputBox} {...disabledProps} />
                            </Form.Item>
                        </Col>
                    </Row>
                    ...
                    <Row gutter={20}>
                        <Col xs={24} sm={12} md={12} lg={12} xl={12} className={styles.padRight18}>
                            <Form.Item initialValue={formData?.longDescription} label="Long Description" name="parentGroup[0].longDescription" rules={[validateRequiredInputField('Name')]}>
                                <Input placeholder="Enter Data" className={styles.inputBox} {...disabledProps} />
                            </Form.Item>
                        </Col>

                        <Col xs={24} sm={12} md={12} lg={12} xl={12} className={styles.padRight18}>
                            <Form.Item initialValue={formData?.ownerName} label="Owner Name" name="parentGroup[0].ownerName" rules={[validateRequiredInputField('Name')]}>
                                <Input placeholder="Enter Data" className={styles.inputBox} {...disabledProps} />
                            </Form.Item>
                        </Col>
                    </Row>
                    ...
                    <Row gutter={20}>
                        <Col xs={24} sm={12} md={12} lg={12} xl={12} className={styles.padRight18}>
                            <Form.Item initialValue={formData?.contactNumber} label="Contact Number" name="parentGroup[0].contactNumber" rules={[validateRequiredInputField('Name')]}>
                                <Input placeholder="Enter Data" className={styles.inputBox} {...disabledProps} />
                            </Form.Item>
                        </Col>
                        <Col xs={24} sm={12} md={12} lg={12} xl={12} className={styles.padRight18}>
                            <Form.Item initialValue={formData?.emailId} label="Email ID" name="parentGroup[0].emailId" rules={[validateRequiredInputField('Name')]}>
                                <Input placeholder="Enter Data" className={styles.inputBox} {...disabledProps} />
                            </Form.Item>
                        </Col>
                    </Row>
                    ...
                    <Row gutter={20}>
                        <Col xs={24} sm={12} md={12} lg={12} xl={12} className={styles.padLeft10}>
                            <Form.Item label="Status" name="parentGroup[0].isActive">
                                <Switch checkedChildren="Active" defaultChecked onChange={() => setIsChecked(!isChecked)} value={(formData?.isActive === 'Y' ? 1 : 0) || isChecked} unCheckedChildren="Inactive" {...disabledProps} />
                            </Form.Item>
                        </Col>
                    </Row>
