    ...
    return (
        <>
            ...
            <Row gutter={20}>
                ...
                <Col xs={24} sm={12} md={12} lg={12} xl={12} className={styles.padRight18}>
                    <Form.Item initialValue={formData?.geoName} label="Short Description" name="geoName" rules={[validateRequiredInputField('Name')]}>
            ...
            <Row gutter={20}>
                <Col xs={24} sm={12} md={12} lg={12} xl={12} className={styles.padRight18}>
                    <Form.Item initialValue={formData?.geoName} label="Long Description" name="geoName" rules={[validateRequiredInputField('Name')]}>
                        <Input placeholder="Enter Data" className={styles.inputBox} {...disabledProps} />
                    </Form.Item>
                </Col>
