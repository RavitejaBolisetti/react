    ...
    return (
        <div>
            <Search
                ...
                onChange={onChange}
            />
            <Tree onExpand={onExpand} expandedKeys={expandedKeys} fieldNames={fieldNames} showLine={true} showIcon={true} autoExpandParent={autoExpandParent} treeData={defaultData1} />
        </div>
    );
};
