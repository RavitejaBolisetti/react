            ...
            {viewMode ? (
                ...
                <>
                    ...
                    <Row gutter={16}>
                        ...
                        <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                            <Form.Item initialValue={formData?.name} label="District Name" name="name" rules={[validateRequiredInputField('district Name'), validateAlphanumericWithSpace('District Name')]}>
