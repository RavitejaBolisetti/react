...
export const withDrawer =
    ...
    (props) => {
        ...
        return (
            <Drawer title={title} width={width} open={onOpenAction} footer={footer} onClose={onCloseAction} visible={isVisible} className={styles.myDrawerStyle} keyboard={false} maskClosable={false}>
