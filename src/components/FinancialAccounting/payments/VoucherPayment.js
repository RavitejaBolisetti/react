...
import VehicleInvoiceFilter from './VoucherPaymentFilter';
...
import { PaymentMainConatiner } from './VoucherPaymentMainConatiner';
...
export const VoucherPaymentBase = (props) => {
    ...
    useEffect(() => {
        const defaultSection = VOUCHER_PAYMENT_SECTION.INVOICE_DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(VOUCHER_PAYMENT_SECTION);
    ...
    const containerProps = {
        ...
        onCloseAction,
        titleOverride: drawerTitle(formActionType).concat(' ').concat(translateContent('Voucher Payment')),
        tableData: data,
        ADD_ACTION,
        EDIT_ACTION,
        VIEW_ACTION,
    ...
    return (
        <>
            ...
            <PaymentMainConatiner {...containerProps} />
...
export const VoucherPayment = connect(mapStateToProps, mapDispatchToProps)(VoucherPaymentBase);
