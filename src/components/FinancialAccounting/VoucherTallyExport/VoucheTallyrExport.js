...
import VoucherTallyExportFilter from './VoucherTallyExportFilter';
...
export const VoucherTallyExportBase = (props) => {
    ...
    const containerProps = {
        ...
        onCloseAction,
        titleOverride: drawerTitle(formActionType).concat(' ').concat(translateContent('Voucher Export')),
        tableData: data,
        ADD_ACTION,
        EDIT_ACTION,
        VIEW_ACTION,
    ...
    return (
        <>
            ...
            <VoucherTallyExportMain {...containerProps} />
...
export const VoucherTallyExport = connect(mapStateToProps, mapDispatchToProps)(VoucherTallyExportBase);
