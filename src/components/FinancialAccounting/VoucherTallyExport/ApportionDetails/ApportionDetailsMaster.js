...
import ViewAddressList from './ViewApportionDetailsList';
...
const ApportionDetailsMasterBase = (props) => {
    ...
    const noDataTitle = 'Apportion Details';
    const addDataTitle = (
...
export const ApportionDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(ApportionDetailsMasterBase);
