        ...
        <Form autoComplete="off" layout="vertical" form={apportionForm} onFinishFailed={onFinishFailed}>
            <Row gutter={20}>
                <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                    ...
                    <Row gutter={20}>
                        <Col xs={24} sm={24} md={12} lg={12} xl={12} xxl={12}>
                            <Form.Item label="Write-Off Amount" name="writeOffAmount" rules={[validateRequiredInputField('Write-Off Amount')]}>
                                <Input maxLength={30} placeholder={preparePlaceholderText('Write-Off Amount')} />
                            </Form.Item>
                        </Col>
                        <Col xs={24} sm={24} md={12} lg={12} xl={12} xxl={12}>
                            <Form.Item label="Apportion Amount" name="apportionAmount" rules={[validateRequiredInputField('Apportion Amount')]}>
