...
import { tableColumn } from './brandSpiderSearchtableColums';

import styles from 'assets/sass/app.module.scss';
import { translateContent } from 'utils/translateContent';

export const BrandSpiderNameSearchForm = (props) => {
...
export const BrandSpiderNameSearch = withModal(BrandSpiderNameSearchForm, { width: '60%' });
