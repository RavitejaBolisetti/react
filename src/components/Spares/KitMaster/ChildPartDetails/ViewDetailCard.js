                    ...
                    <Col xs={18} sm={18} md={18} lg={18} xl={18} xxl={18}>
                        <Row>
                            <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                {'Child Part No : ' || translateContent('applicationMaster.text.code')}
                                <Text strong>{formData?.cildPartNo}</Text>
                            </Col>
                            <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                {'Child Part Description : ' || translateContent('applicationMaster.text.code')}
                                <Text strong> {formData?.childPartDescription}</Text>
                            </Col>
                            <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                {'Child Part Quantity : ' || translateContent('applicationMaster.text.code')}
                                <Text strong> {formData?.childPartQuantity}</Text>
                            </Col>
                        </Row>
                    </Col>
