...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Movement Class';
...
export const MovementClassMasterBase = (props) => {
...
export const MovementClassMaster = connect(mapStateToProps, mapDispatchToProps)(MovementClassMasterBase);
