...
import VehicleInvoiceFilter from './TargetTypeFilter';
import { validateInvoiceMenu } from './LeftProfileCard/validateInvoiceMenu';
import { ReportModal } from 'components/common/ReportModal/ReportModal';
// import { VehicleInvoiceMainConatiner } from './VoucherPaymentMainConatiner';
...
import { TargetTypeMainConatiner } from './TargetTypeMainConatiner';
...
export const TargetTypeBase = (props) => {
    ...
    useEffect(() => {
        const defaultSection = TARGET_TYPE_SECTION.TARGET_TYPE_DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(TARGET_TYPE_SECTION);
    ...
    const containerProps = {
        ...
        onCloseAction,
        titleOverride: drawerTitle(formActionType).concat(' ').concat(translateContent('Target Type')),
        tableData: data,
        ADD_ACTION,
        EDIT_ACTION,
        VIEW_ACTION,
    ...
    return (
        <>
            ...
            <TargetTypeMainConatiner {...containerProps} />
...
export const TargetType = connect(mapStateToProps, mapDispatchToProps)(TargetTypeBase);
