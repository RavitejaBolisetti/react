...
import { CustomerFormButton } from '../../../common/CustomerMaster/CustomerFormButton';
import ViewList from './ViewTargetTypeDetailsList';
...
const TargetTypeDetailsMasterBase = (props) => {
    ...
    const noDataTitle = 'Target Type Details';
    const addDataTitle = (
                            ...
                            {isAddressLoading || isCorporateAddressLoading ? (
                                ...
                                <>
                                    <Row type="flex" align="middle">
                                        <Text strong> Target Type Details </Text>
...
export const TargetTypesDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(TargetTypeDetailsMasterBase);
