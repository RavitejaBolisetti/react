...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Vendor Brand';
...
export const VendorBrandMasterBase = (props) => {
...
export const VendorBrandMaster = connect(mapStateToProps, mapDispatchToProps)(VendorBrandMasterBase);
