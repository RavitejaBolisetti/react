        ...
        <Form autoComplete="off" layout="vertical" form={editVehicleDetailsForm} onFinish={onFinish}>
            <Row gutter={24}>
                <Col xs={24} sm={24} md={8} lg={8} xl={8}>
                    <Form.Item label={'Part Description'|| translateContent('stockTransferIndent.label.modelDescription')} name="modelDescription" initialValue={formData?.modelDescription}>
                        <Input placeholder={preparePlaceholderText(translateContent('stockTransferIndent.label.modelDescription'))} disabled={true}></Input>
                    </Form.Item>
                </Col>
                <Col xs={24} sm={24} md={8} lg={8} xl={8}>
                    <Form.Item label={translateContent("Part No" || 'stockTransferIndent.label.modelCode')} name="modelCode" initialValue={formData?.modelCode}>
