...
const ViewIndentDetailMain = (props) => {
    ...
    return (
        <Card>
            ...
            <Descriptions {...viewProps}>
                <Descriptions.Item label={translateContent('Part Description')}>{checkAndSetDefaultValue(viewData?.modelDescription, isLoading)}</Descriptions.Item>
                <Descriptions.Item label={translateContent('Part Number')}>{checkAndSetDefaultValue(viewData?.modelCode, isLoading)}</Descriptions.Item>
