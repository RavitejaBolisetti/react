                ...
                <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                    <Card>
                        <Descriptions {...viewProps}>
                            ...
                            <Descriptions.Item label={translateContent('Total Indent Quantity')}>{checkAndSetDefaultValue(formData?.indentToLocation, isLoading)}</Descriptions.Item>
                            <Descriptions.Item label={translateContent('Total Indent Value')}>{checkAndSetDefaultValue(formData?.indentToLocation, isLoading)}</Descriptions.Item>
                    ...
                    <Card>
                        <Row gutter={24}>
                            <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                                <h4>{ 'Part Details' ||translateContent('stockTransferIndent.heading.vehicleDetails')}</h4>
                                <Divider />
                            </Col>
                            <Col xs={24} sm={24} md={24} lg={24} xl={24}>
