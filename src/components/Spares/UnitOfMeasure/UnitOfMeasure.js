...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Unit Of Measure';
...
export const UnitOfMeasureMasterBase = (props) => {
...
export const UnitOfMeasure = connect(mapStateToProps, mapDispatchToProps)(UnitOfMeasureMasterBase);
