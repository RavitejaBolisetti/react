...
const StockDetailsMasterBase = (props) => {
...
const StockDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(StockDetailsMasterBase);
export default StockDetailsMaster;
