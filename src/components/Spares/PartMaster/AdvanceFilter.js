...
export default function AdvanceFilter(props) {
    const { extraParams, singleField, removeFilter, handleButtonClick, handleResetFilter, advanceFilter = false, otfFilter = false, title, filterString, setFilterString, typeData, setAdvanceSearchVisible, searchForm } = props;
