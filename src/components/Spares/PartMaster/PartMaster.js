...
import { PartMasterContainer } from './PartMasterContainer';
...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Part Master Details';
...
export const PartMasterBase = (props) => {
    ...
    useEffect(() => {
        const defaultSection = PART_MASTER_SECTION.PART_DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(PART_MASTER_SECTION);
    ...
    return (
        <>
            ...
            <PartMasterContainer {...containerProps} />
        </>
    );
};

export const PartMaster = connect(mapStateToProps, mapDispatchToProps)(PartMasterBase);
