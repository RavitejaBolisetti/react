...
const InventoryDetailsMasterBase = (props) => {
...
const InventoryDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(InventoryDetailsMasterBase);
export default InventoryDetailsMaster;
