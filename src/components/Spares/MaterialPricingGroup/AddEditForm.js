                        ...
                        <>
                            <Row gutter={16}>
                                ...
                                <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                                    <Form.Item label={translateContent('Group Code' || 'city.label.countryCode')} name="groupCode" rules={[validateRequiredInputField('Group Code' || translateContent('city.validation.country'))]}>
                                        <Input placeholder={preparePlaceholderText('Group Code' || translateContent('city.placeholder.cityCode'))} />
                                    </Form.Item>
                                </Col>
                                <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                                    <Form.Item label={translateContent('Group Description' || 'city.label.countryCode')} name="groupDescription" rules={[validateRequiredInputField('Group Description' || translateContent('city.validation.country'))]}>
                                        <Input placeholder={preparePlaceholderText('Group Description' || translateContent('city.placeholder.cityCode'))} />
                                    </Form.Item>
                                </Col>
