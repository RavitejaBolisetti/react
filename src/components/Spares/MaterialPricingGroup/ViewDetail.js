        ...
        <>
            <div className={`${styles.viewContainer} ${styles.viewOneColProps}`}>
                <Descriptions {...viewOneColProps}>
                    ...
                    <Descriptions.Item label={'Group Code' || translateContent('city.label.stateName')}>{formData?.groupCode}</Descriptions.Item>
                    <Descriptions.Item label={'Group Description' || translateContent('city.label.stateName')}>{formData?.groupDescription}</Descriptions.Item>
