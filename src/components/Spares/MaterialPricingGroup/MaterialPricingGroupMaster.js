...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Material Pricing Group';
...
export const MaterialPricingGroupMasterBase = (props) => {
...
export const MaterialPricingGroupMaster = connect(mapStateToProps, mapDispatchToProps)(MaterialPricingGroupMasterBase);
