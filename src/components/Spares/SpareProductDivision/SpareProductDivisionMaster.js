...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Spare Product Division';
...
export const SpareProductDivisionMasterBase = (props) => {
...
export const SpareProductDivisionMaster = connect(mapStateToProps, mapDispatchToProps)(SpareProductDivisionMasterBase);
