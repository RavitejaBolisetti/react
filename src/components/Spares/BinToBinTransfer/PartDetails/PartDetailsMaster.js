...
const PartDetailsMasterBase = (props) => {
    ...
    const addDataTitle = (
        <p className={styles.textCenter}>
            Please add new part detail using <br /> <strong>“Add”</strong> button at top
        </p>
    );
    ...
    return (
        <>
            <Form layout="vertical" autoComplete="off" form={form} onValuesChange={handleFormValueChange} onFieldsChange={handleFormValueChange} onFinish={onFinish}>
                <Row gutter={20}
                 className={styles.drawerBodyRight}
...
export const PartDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(PartDetailsMasterBase);
