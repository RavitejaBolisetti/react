...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Campaign Discount';
...
export const CampaignDiscountMasterBase = (props) => {
...
export const CampaignDiscountMaster = connect(mapStateToProps, mapDispatchToProps)(CampaignDiscountMasterBase);
