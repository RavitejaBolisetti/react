            ...
            <Collapse expandIcon={expandIcon} activeKey={activeKey} onChange={() => onChange(1)} expandIconPosition="end" collapsible="icon">
                <Panel header={translateContent('shieldSchemeRegistration.heading.vehicleDetails')} key="1">
                    ...
                    <Descriptions {...viewProps}>
                        ...
                        <Descriptions.Item label={translateContent('shieldSchemeRegistration.label.modelGroup')}>{checkAndSetDefaultValue(getCodeValue(ProductHierarchyData, formData?.vehicleDetails?.modelGroup, isLoading))}</Descriptions.Item>
