...
const AddEditForm = (props) => {
    const { addressForm, setAddressData, activeKey, addressData, editingData, setEditingData, setShowAddEditForm, setIsEditing, uploadProps, formData } = props;
            ...
            <Form form={addressForm} id="myAdd" onFinish={handleSave} onFieldsChange={handleFormValueChange} autoComplete="off" layout="vertical">
                ...
                <Card>
                    ...
                    <Row gutter={20}>
                        ...
                        <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                            <Form.Item label={translateContent('demandForecasting.label.currentMonth')} name="currentMonth" rules={[validateRequiredSelectField(translateContent('demandForecasting.validation.currentMonth'))]}>
                                {customSelectBox({ data: month, placeholder: preparePlaceholderSelect(translateContent('demandForecasting.label.currentMonth')) })}
                            </Form.Item>
                        </Col>

                        <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                            <Form.Item label={translateContent('demandForecasting.label.currentMonth1')} name="currentMonth1" rules={[validateRequiredSelectField(translateContent('demandForecasting.validation.currentMonth1'))]}>
                                {customSelectBox({ data: month, placeholder: preparePlaceholderSelect(translateContent('demandForecasting.label.currentMonth1')) })}
                            </Form.Item>
                        </Col>

                        <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                            <Form.Item label={translateContent('demandForecasting.label.currentMonth2')} name="currentMonth2" rules={[validateRequiredSelectField(translateContent('demandForecasting.validation.currentMonth2'))]}>
                                {customSelectBox({ data: month, placeholder: preparePlaceholderSelect(translateContent('demandForecasting.label.currentMonth2')) })}
                            </Form.Item>
                        </Col>

                        <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                            <Form.Item label={translateContent('demandForecasting.label.currentMonth3')} name="currentMonth3" rules={[validateRequiredSelectField(translateContent('demandForecasting.validation.currentMonth3'))]}>
                                {customSelectBox({ data: month, placeholder: preparePlaceholderSelect(translateContent('demandForecasting.label.currentMonth3')) })}
                            </Form.Item>
                        </Col>
