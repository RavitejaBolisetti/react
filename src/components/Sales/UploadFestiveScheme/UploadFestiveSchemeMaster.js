...
import { UploadFestiveSchemeMasterContainer } from './UploadFestiveSchemeMasterContainer';
...
export const UploadFestiveSchemeMasterBase = (props) => {
    ...
    const [sectionName, setSetionName] = useState(UPLOAD_FESTIVE_SCHEME_SECTION);
    ...
    useEffect(() => {
        const defaultSection = UPLOAD_FESTIVE_SCHEME_SECTION.DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(UPLOAD_FESTIVE_SCHEME_SECTION);
    ...
    return (
        <>
            ...
            <UploadFestiveSchemeMasterContainer {...containerProps} />
        </>
    );
};
