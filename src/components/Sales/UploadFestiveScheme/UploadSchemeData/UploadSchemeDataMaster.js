...
const UploadSchemeDataMasterBase = (props) => {
...
const UploadSchemeDataMaster = connect(mapStateToProps, mapDispatchToProps)(UploadSchemeDataMasterBase);
export default UploadSchemeDataMaster;
