                    ...
                    <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                        <div className={styles.contentHeaderBackground}>
                            <Space direction="vertical">
                                <Space className={styles.accordianIconWithText}>{translateContent('Festive Scheme Form')}</Space>
                                <Space>{translateContent('Please download Festive Scheme Form Template using below button')}</Space>
                                <Space>
                        ...
                        <UploadUtil {...props} uploadButtonName={translateContent('Upload Festive Scheme')} handleFormValueChange={handleFormValueChange} />
                    </Col>
                </Row>
