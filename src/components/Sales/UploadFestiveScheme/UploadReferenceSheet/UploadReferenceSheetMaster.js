...
const UploadReferenceSheetMasterBase = (props) => {
...
const UploadReferenceSheetMaster = connect(mapStateToProps, mapDispatchToProps)(UploadReferenceSheetMasterBase);
export default UploadReferenceSheetMaster;
