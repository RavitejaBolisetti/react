...
const statusFilter = [
 ...
 const OverRiderClaimMasterBase = (props) => {
    ...
    useEffect(() => {
        const defaultSection = OVER_RIDER_CLAIM_SECTION.CLAIM_DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(OVER_RIDER_CLAIM_SECTION);
    ...
    return (
        <>
            ...
            <EmployeeEmpowermentMainContainer {...containerProps} />
        </>
    );
};

export const OverRiderClaimMaster = connect(mapStateToProps, mapDispatchToProps)(OverRiderClaimMasterBase);
