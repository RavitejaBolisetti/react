...
import { CustomerEmpowermentMainContainer } from './CustomerEmpowermentMainContainer';
...
export const CustomerEmpowermentMasterBase = (props) => {
    ...
    const advanceFilterResultProps = {
        ...
        onFinish,
        onFinishFailed,
        // title: <span style={{ whiteSpace: 'nowrap', marginRight: '20px' }}>{'Customer Empowerment'}</span>,
    ...
    return (
        <>
            ...
            <CustomerEmpowermentMainContainer {...containerProps} />
        </>
    );
};

export const CustomerEmpowermentMaster = connect(mapStateToProps, mapDispatchToProps)(CustomerEmpowermentMasterBase);
