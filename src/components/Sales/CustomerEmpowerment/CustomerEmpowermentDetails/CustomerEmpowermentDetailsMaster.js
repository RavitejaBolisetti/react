...
const CustomerEmpowermentDetailsMain = (props) => {
    ...
    console.log("🚀 ~ file: CustomerEmpowermentDetailsMaster.js:46 ~ CustomerEmpowermentDetailsMain ~ formActionType:", formActionType)
...
export const CustomerEmpowermentDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(CustomerEmpowermentDetailsMain);
