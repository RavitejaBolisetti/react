...
export const CustomerEmpowermentFormButton = ({ record, onCloseAction, buttonData, setButtonData, saveButtonName = translateContent('global.buttons.continue'), handleButtonClick, isLoadingOnSave, isLastSection, buttonType = false }) => {
    return (
