...
const ViewDetailMain = (props) => {
    ...
    const customerDetail = (customerData) => (
        <Descriptions {...viewProps}>
            ...
            <Descriptions.Item label="Gender">{checkAndSetDefaultValue(getCodeValue(typeData?.GENDER_CD, customerData?.gender), isLoading)}</Descriptions.Item>
            {showAgeGroup && <Descriptions.Item label="Age Group">{checkAndSetDefaultValue(getCodeValue(typeData?.AGE_LIMIT, customerData?.ageGroup), isLoading)}</Descriptions.Item>}
