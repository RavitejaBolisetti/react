...
export const ExchangeLoyaltyClaimMasterBase = (props) => {
...
export const ExchangeLoyaltyIncentiveMaster = connect(mapStateToProps, mapDispatchToProps)(ExchangeLoyaltyClaimMasterBase);
