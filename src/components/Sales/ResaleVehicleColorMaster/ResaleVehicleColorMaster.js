...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Exchange Vehicle Color Master';
...
export const ResaleVehicleColorMasterBase = (props) => {
...
export const ResaleVehicleColorMaster = connect(mapStateToProps, mapDispatchToProps)(ResaleVehicleColorMasterBase);
