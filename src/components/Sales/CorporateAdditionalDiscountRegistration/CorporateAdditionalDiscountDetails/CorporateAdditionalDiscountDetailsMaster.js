...
const CorporateAdditionalDiscountDetailsMain = (props) => {
...
export const CorporateAdditionalDiscountDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(CorporateAdditionalDiscountDetailsMain);
