...
import { CorporateAdditionalDiscountRegistrationMainContainer } from './CorporateAdditionalDiscountRegistrationMainContainer';
...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Corporate Additional Discount';
...
export const CorporateAdditionalDiscountRegistrationBase = (props) => {
    ...
    useEffect(() => {
        const defaultSection = CORPORATE_ADDITIONAL_DISCOUNT_SECTION.CLAIM_DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(CORPORATE_ADDITIONAL_DISCOUNT_SECTION);
    ...
    return (
        <>
            ...
            <CorporateAdditionalDiscountRegistrationMainContainer {...containerProps} />

        </>
    );
};

export const CorporateAdditionalDiscountRegistrationMaster = connect(mapStateToProps, mapDispatchToProps)(CorporateAdditionalDiscountRegistrationBase);
