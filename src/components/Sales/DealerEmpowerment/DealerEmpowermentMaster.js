...
export const DealerEmpowermentMasterBase = (props) => {
...
export const DealerEmpowermentMaster = connect(mapStateToProps, mapDispatchToProps)(DealerEmpowermentMasterBase);
