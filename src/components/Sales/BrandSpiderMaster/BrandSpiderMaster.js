...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Brand Spider';
...
export const BrandSpiderMasterBase = (props) => {
...
export const BrandSpiderMaster = connect(mapStateToProps, mapDispatchToProps)(BrandSpiderMasterBase);
