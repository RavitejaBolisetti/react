...
import MahindraVsCompetitorMaster from './MahindraVsCompetitor';
                            ...
                            <>
                                <Row gutter={16}>
                                    <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                                        <Form.Item label={translateContent('Brand Spider Name' || 'city.label.countryCode')} name="brandSpiderName" placeholder={preparePlaceholderSelect('Brand Spider Name' || translateContent('city.placeholder.country'))} rules={[validateRequiredInputField('Brand Spider Name' || translateContent('city.validation.country'))]}>
                                            <Input placeholder={preparePlaceholderText('Brand Spider Name' || translateContent('city.placeholder.cityCode'))} disabled={editMode ? true : false} />
                                        </Form.Item>
                                    </Col>
                                    {/* 
