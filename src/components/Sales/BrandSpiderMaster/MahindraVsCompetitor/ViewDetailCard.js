                    ...
                    <Col xs={18} sm={18} md={18} lg={18} xl={18} xxl={18}>
                        <Row>
                            <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                {'Mahindra Make : ' || translateContent('applicationMaster.text.code')}
                                <Text strong>{formData?.mahindraMake}</Text>
                            </Col>
                            <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                {'Mahindra Model : ' || translateContent('applicationMaster.text.code')}
                                <Text strong> {formData?.mahindraMake}</Text>
                            </Col>
                            <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                {'Mahindra Varient : ' || translateContent('applicationMaster.text.code')}
                                <Text strong> {formData?.mahindraModel}</Text>
                            </Col>
                            <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                {'Mahindra Model : ' || translateContent('applicationMaster.text.code')}
                                <Text strong> {formData?.mahindraVarient}</Text>
                            </Col>
                            <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                {'Competitor Model : ' || translateContent('applicationMaster.text.code')}
                                <Text strong> {formData?.competitorMake}</Text>
                            </Col>
                            <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                {'Competitor Model : ' || translateContent('applicationMaster.text.code')}
                                <Text strong> {formData?.competitorModel}</Text>
                            </Col>
                            <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                                {'Competitor Model : ' || translateContent('applicationMaster.text.code')}
                                <Text strong> {formData?.competitorVarient}</Text>
                            </Col>
                        </Row>
                    </Col>
