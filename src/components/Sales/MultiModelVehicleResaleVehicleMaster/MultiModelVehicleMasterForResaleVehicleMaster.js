...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Multi Modal Vehicle';
...
export const MultiModelVehicleMasterForResaleVehicleMasterBase = (props) => {
...
export const MultiModelVehicleMasterForResaleVehicleMaster = connect(mapStateToProps, mapDispatchToProps)(MultiModelVehicleMasterForResaleVehicleMasterBase);
