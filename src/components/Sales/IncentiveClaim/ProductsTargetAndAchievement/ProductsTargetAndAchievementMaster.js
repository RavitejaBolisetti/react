...
const ProductsTargetAndAchievementBase = (props) => {
                            ...
                            {isAddressLoading || isCorporateAddressLoading ? (
                                ...
                                <>
                                    <Row type="flex" align="middle">
                                        <Text strong> {'Products & Targets'}</Text>
...
export const ProductsTargetAndAchievementMaster = connect(mapStateToProps, mapDispatchToProps)(ProductsTargetAndAchievementBase);
