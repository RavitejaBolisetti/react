...
import { IncentiveClaimMasterContainer } from './IncentiveClaimMasterContainer';
...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Incentive Claim';
...
export const IncentiveClaimMasterBase = (props) => {
    ...
    useEffect(() => {
        const defaultSection = INCENTIVE_CLAIM_SECTION.DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(INCENTIVE_CLAIM_SECTION);
    ...
    return (
        <>
            ...
            <IncentiveClaimMasterContainer {...containerProps} />
        </>
    );
};

export const IncentiveClaimMaster = connect(mapStateToProps, mapDispatchToProps)(IncentiveClaimMasterBase);
