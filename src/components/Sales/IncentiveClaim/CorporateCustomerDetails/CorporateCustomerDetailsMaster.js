...
const CorporateCustomerDetailsMain = (props) => {
    ...
    console.log("🚀 ~ file: SchemeDetailsMaster.js:46 ~ SchemeDetailsMain ~ formActionType:", formActionType)
...
export const CorporateCustomerDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(CorporateCustomerDetailsMain);
