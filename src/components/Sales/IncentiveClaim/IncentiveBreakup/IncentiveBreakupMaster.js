...
const IncentiveBreakupMasterBase = (props) => {
                            ...
                            {isAddressLoading || isCorporateAddressLoading ? (
                                ...
                                <>
                                    <Row type="flex" align="middle">
                                        <Text strong> {'Incentive Breakup'}</Text>
...
export const IncentiveBreakupMaster = connect(mapStateToProps, mapDispatchToProps)(IncentiveBreakupMasterBase);
