...
export const EmployeeEmpowermentMasterBase = (props) => {
    ...
    useEffect(() => {
        const defaultSection = EMPLOYEE_EMPOWERMENT_SECTION.CLAIM_DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(EMPLOYEE_EMPOWERMENT_SECTION);
...
export const EmployeeEmpowermentMaster = connect(mapStateToProps, mapDispatchToProps)(EmployeeEmpowermentMasterBase);
