...
const ReferralsMasterBase = (props) => {
    const { formActionType, showGlobalNotification, isLoading } = props;
    const { form, section, handleFormValueChange, onFinishFailed, typeData } = props;
...
export const ReferralsMaster = connect(null, null)(ReferralsMasterBase);
