...
export const ExchangeDetailsMasterBase = (props) => {
                ...
                <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                    <Row>
                        <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                            <h2>{/* {section?.title} */}Exchange Details</h2>
                        </Col>
                    </Row>
...
export const ExchangeDetailsMaster = connect(null, null)(ExchangeDetailsMasterBase);
