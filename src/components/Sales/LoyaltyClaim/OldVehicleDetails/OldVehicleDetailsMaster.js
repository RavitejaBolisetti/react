...
const OldVehicleDetailsMain = (props) => {
    ...
    console.log("🚀 ~ file: EmployeeEmpowermentOldVehicleDetailsMaster.js:46 ~ EmployeeEmpowermentOldVehicleDetailsMain ~ formActionType:", formActionType)
...
export const OldVehicleDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(OldVehicleDetailsMain);
