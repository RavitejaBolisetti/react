...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Loyalty Claim';
...
export const LoyaltyClaimMasterBase = (props) => {
    ...
    return (
        <>
            ...
            <LoyaltyClaimMasterContainer {...containerProps} />
...
export const LoyaltyClaimMaster = connect(mapStateToProps, mapDispatchToProps)(LoyaltyClaimMasterBase);
