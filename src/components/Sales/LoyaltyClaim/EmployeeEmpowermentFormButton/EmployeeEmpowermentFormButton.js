...
export const EmployeeEmpowermentFormButton = ({ record, onCloseAction, buttonData, setButtonData,handleApprovalChangeHistory,handleExchangeClaimChangeHistory, saveButtonName = translateContent('global.buttons.continue'), handleButtonClick, isLoadingOnSave, isLastSection, buttonType = false }) => {
    return (
