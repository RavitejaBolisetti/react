                    ...
                    <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                        <div className={styles.contentHeaderBackground}>
                            <Space direction="vertical">
                                <Space className={styles.accordianIconWithText}>{ 'Scheme Registration Form' || translateContent('adminHierarchy.label.authorityForm')}</Space>
                                <Space>{ "Please download 'Scheme Registration Form Template' using below button" ||translateContent('adminHierarchy.label.downloadAuthorityForm')}</Space>
                                <Space>
                        ...
                        <UploadUtil {...props} uploadButtonName={ 'Upload Scheme Registration Form' || translateContent('adminHierarchy.label.uploadButtonName')} messageText={translateContent('adminHierarchy.label.messageText')} validationText={translateContent('adminHierarchy.validation.validationText')} handleFormValueChange={handleFormValueChange} />
                    </Col>
                </Row>
...
export const SchemeRegistrationBulkUpload = withDrawer(UploadMain, { title: translateContent('global.buttons.upload'), width: '520px' });
