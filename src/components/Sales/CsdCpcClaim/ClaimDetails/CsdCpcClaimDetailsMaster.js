...
import { CsdCpcFormButton } from '../CsdCpcFormButton';
...
const CsdCpcClaimDetailsMain = (props) => {
        ...
        <Form layout="vertical" autoComplete="off" form={form} onValuesChange={handleFormValueChange} onFieldsChange={handleFormValueChange} onFinish={onFinish}>
            ...
            <Row>
                <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                    <CsdCpcFormButton {...props} />
                </Col>
            </Row>
        </Form>
    );
};
export const CsdCpcClaimDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(CsdCpcClaimDetailsMain);
