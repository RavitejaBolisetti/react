            ...
            <Row gutter={16}>
                ...
                <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                    <Form.Item label="Claim Type" name="zone">
                        <Select optionFilterProp="children" options={claimType || []} placeholder={preparePlaceholderSelect('Claim Type')} fieldNames={{ label: 'value', value: 'key' }} loading={isModelDataLoading} allowClear showSearch filterOption={(input, option) => (option?.prodctShrtName ?? '').toLowerCase().includes(input.toLowerCase())} />
                    </Form.Item>
                </Col>
            </Row>
