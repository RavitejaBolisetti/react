...
import { CsdCpcClaimDetailsMaster } from './ClaimDetails';

const CsdCpcClaimMainContainerMain = (props) => {
    ...
    const renderElement = () => {
        switch (currentSection) {
            case DEALER_CORPORATE_SECTION.CLAIM_DETAILS.id: {
                return <CsdCpcClaimDetailsMaster {...myProps} />;
            }
...
export const CsdCpcClaimMainContainer = withDrawer(CsdCpcClaimMainContainerMain, { width: '90%', footer: null });
