...
import { CsdCpcClaimMainContainer } from './CsdCpcClaimMainContainer';
...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'CSD/CPC Claim';
...
export const CsdCpcClaimBase = (props) => {
    ...
    return (
        <>
            ...
            <CsdCpcClaimMainContainer {...containerProps} />
        </>
    );
};

export const CsdCpcClaimMaster = connect(mapStateToProps, mapDispatchToProps)(CsdCpcClaimBase);
