            ...
            <Form form={cancelForm} layout="vertical" autocomplete="off" colon="false">
                <Row gutter={20}>
                    <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={12}>
                        <Form.Item name="transferLocation" label="Transfer To Location" initialValue={formData?.transferLocation} rules={[validateRequiredSelectField('Transfer To Location')]}>
                            <Select
                                {...selectProps}
                                placeholder="Select"
                    ...
                    <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={12}>
                        <Form.Item name="saleConsultant" label="Sales Consultant" initialValue={formData?.saleConsultant} rules={[validateRequiredSelectField('Sales Consultant')]}>
                            <Select
                                {...selectProps}
                                style={{
                                    width: '100%',
                ...
                <Row>
                    <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                        <Form.Item name="reasonForTransfer" label="Reason For Transfer" initialValue={formData?.reasonForTransfer} rules={[validateRequiredSelectField('Reason For Transfer')]}>
                            <Select
                                {...selectProps}
                                style={{
                                    width: '100%',
