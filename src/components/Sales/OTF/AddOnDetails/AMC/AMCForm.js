            ...
            <Row gutter={20}>
                <Col xs={8} sm={8} md={8} lg={8} xl={8} xxl={8}>
                    <Form.Item label={translateContent('bookingManagement.label.amc')} name="amc">
                        <Input disabled={true} placeholder={preparePlaceholderText(translateContent('bookingManagement.label.amc'))} />
                    </Form.Item>
                </Col>
                <Col xs={8} sm={8} md={8} lg={8} xl={8} xxl={8}>
                    <Form.Item label={translateContent('bookingManagement.label.amcRate')} name="amcRate" rules={[validateNumberWithTwoDecimalPlaces(translateContent('bookingManagement.label.amcRate'))]}>
                        <Input disabled={true} placeholder={preparePlaceholderText(translateContent('bookingManagement.label.amcRate'))} />
                    </Form.Item>
                </Col>
            </Row>
        </Form>
