...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'CSD/CPC Scheme';
...
export const AdditionalCsdCpcClaimBase = (props) => {
        ...
        tableData: [
            {
                schemeType: 'CC999',
                schemeNo: 'Test Corp',
                effectiveFrom: '07/12/1999',
                effectiveTo: '07/12/2030',
            },
        ],
    };
...
export const AdditionalCsdCpcClaimMaster = connect(mapStateToProps, mapDispatchToProps)(AdditionalCsdCpcClaimBase);
