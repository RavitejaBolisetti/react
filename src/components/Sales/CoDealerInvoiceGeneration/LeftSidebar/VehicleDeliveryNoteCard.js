    ...
    return (
        <Collapse bordered={true} expandIcon={expandIcon} collapsible="icon">
            ...
            >
                ...
                <div className={styles.detailCardText}>
                    Status:
                    <div className={styles.tooltipAlign}>{checkAndSetDefaultValue(getCodeValue(typeData[PARAM_MASTER.DLVR_NT_STS.id], selectedOrder?.deliveryNoteStatus, isLoading))}</div>
                </div>
