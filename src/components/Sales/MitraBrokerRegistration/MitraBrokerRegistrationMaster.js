...
import { MitraBrokerRegistrationMasterContainer } from './MitraBrokerRegistrationMasterContainer';
...
export const MitraBrokerRegistrationMasterBase = (props) => {
    ...
    useEffect(() => {
        const defaultSection = MITRA_BROKER_REGISTRATION_SECTION.DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(MITRA_BROKER_REGISTRATION_SECTION);
    ...
    return (
        <>
            ...
            <MitraBrokerRegistrationMasterContainer {...containerProps} />
        </>
    );
};

export const MitraBrokerRegistrationMaster = connect(mapStateToProps, mapDispatchToProps)(MitraBrokerRegistrationMasterBase);
