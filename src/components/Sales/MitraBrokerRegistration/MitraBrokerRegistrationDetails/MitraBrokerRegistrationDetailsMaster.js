...
const MitraBrokerRegistrationMasterDetailsMain = (props) => {
    ...
    console.log("🚀 ~ file: MitraBrokerRegistrationMasterDetailsMaster.js:46 ~ MitraBrokerRegistrationMasterDetailsMain ~ formActionType:", formActionType)
...
export const MitraBrokerRegistrationMasterDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(MitraBrokerRegistrationMasterDetailsMain);
