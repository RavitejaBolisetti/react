...
const DealerAssosiationiDetailsMasterMain = (props) => {
...
export const DealerAssosiationiDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(DealerAssosiationiDetailsMasterMain);
