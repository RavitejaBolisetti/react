...
const DealerAssosiationDetailsMasterBase = (props) => {
                            ...
                            {isAddressLoading || isCorporateAddressLoading ? (
                                ...
                                <>
                                    <Row type="flex" align="middle">
                                        <Text strong> {'Assosiation Details'}</Text>
...
export const DealerAssosiationDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(DealerAssosiationDetailsMasterBase);
