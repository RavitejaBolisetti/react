...
export const GSTClaimMasterBase = (props) => {
    const { userId, data, totalRecords, moduleTitle, loginUserType } = props;
    console.log('🚀 ~ file: GSTClaimMaster.js:94 ~ GSTClaimMasterBase ~ loginUserData:', loginUserType);
    ...
    const onFinish = (data) => {
        console.log('🚀 ~ file: GSTClaimMaster.js:438 ~ onFinish ~ data:', data);
    };
    ...
    return (
        <>
            ...
            <GSTClaimMainContainerMaster {...containerProps} />
        </>
    );
};

export const GSTClaimMaster = connect(mapStateToProps, mapDispatchToProps)(GSTClaimMasterBase);
