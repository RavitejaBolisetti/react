...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Multi Modal Used Vehicle Campaign';
...
export const MultiModelUsedVehicleCampaignCreationMasterBase = (props) => {
    ...
    const tableProps = {
        ...
        scroll: { x: 1400, y: 'calc(100vh - 312px)' },
        tableData: dummyData,
    };
...
export const MultiModelUsedVehicleCampaignCreationMaster = connect(mapStateToProps, mapDispatchToProps)(MultiModelUsedVehicleCampaignCreationMasterBase);
