...
const ApplicableDealersMasterBase = (props) => {
    ...
    const addDataTitle = (
        <p className={styles.textCenter}>
            Please add applicable dealer using <br /> <strong>“Add”</strong> button at top
        </p>
    );
                            ...
                            {isAddressLoading || isCorporateAddressLoading ? (
                                ...
                                <>
                                    <Row type="flex" align="middle">
                                        <Text strong> {'Applicable Dealers'}</Text>
...
export const ApplicableDealersMaster = connect(mapStateToProps, mapDispatchToProps)(ApplicableDealersMasterBase);
