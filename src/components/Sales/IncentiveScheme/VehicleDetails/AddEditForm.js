                    ...
                    <Row gutter={20}>
                        <Col xs={24} sm={24} md={6} lg={6} xl={6} xxl={6}>
                            <Form.Item name="vin" label={'VIN'}>
                                <Input placeholder={preparePlaceholderText('VIN')} />
                            </Form.Item>
                        </Col>
                        <Col xs={24} sm={24} md={6} lg={6} xl={6} xxl={6}>
                            <Form.Item name="ndp" label={'NDP'}>
                                <Input placeholder={preparePlaceholderText('NDP')} />
                            </Form.Item>
                        </Col>
                        <Col xs={24} sm={24} md={6} lg={6} xl={6} xxl={6}>
                            <Form.Item name="percentageOnNdp" label={'% on NDP'} >
                                <Input placeholder={preparePlaceholderText('% on NDP')}   />
                            </Form.Item>
                        </Col>
                        <Col xs={24} sm={24} md={6} lg={6} xl={6} xxl={6}>
