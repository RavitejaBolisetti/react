...
const ApplicableAssosiatesMasterBase = (props) => {
    ...
    const addDataTitle = (
        <p className={styles.textCenter}>
            Please add applicable assosiate <br /> <strong>“Add”</strong> button at top
        </p>
    );
                            ...
                            {isAddressLoading || isCorporateAddressLoading ? (
                                ...
                                <>
                                    <Row type="flex" align="middle">
                                        <Text strong> {'Applicable Assosiate'}</Text>
...
export const ApplicableAssosiatesMaster = connect(mapStateToProps, mapDispatchToProps)(ApplicableAssosiatesMasterBase);
