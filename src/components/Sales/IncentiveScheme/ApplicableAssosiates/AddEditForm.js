                    ...
                    <Row gutter={20}>
                        ...
                        <Col xs={24} sm={24} md={6} lg={6} xl={6} xxl={6}>
                            <Form.Item name="locationName" label={'Location Name'}>
                                <Input placeholder={preparePlaceholderText('Location Name')} />
                            </Form.Item>
                        </Col>
                        <Col xs={24} sm={24} md={6} lg={6} xl={6} xxl={6}>
                            <Form.Item name="assosiateType" label={'Assosiate Type'}>
                                <Input placeholder={preparePlaceholderText('Assosiate Type')} />
                            </Form.Item>
                        </Col>
                        <Col xs={24} sm={24} md={6} lg={6} xl={6} xxl={6}>
                            <Form.Item name="assosiateName" label={'Assosiate Name'}>
                                {customSelectBox({ data: [], placeholder: preparePlaceholderSelect('Assosiate Name' || translateContent('customerMaster.placeholder.corporateName')) })}
                            </Form.Item>
                        </Col>
