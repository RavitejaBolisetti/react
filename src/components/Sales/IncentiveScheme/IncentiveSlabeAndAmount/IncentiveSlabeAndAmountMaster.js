...
const IncentiveSlabeAndAmountMasterBase = (props) => {
                            ...
                            {isAddressLoading || isCorporateAddressLoading ? (
                                ...
                                <>
                                    <Row type="flex" align="middle">
                                        <Text strong> {'Incentive Slabes & Ammount'}</Text>
...
export const IncentiveSlabeAndAmountMaster = connect(mapStateToProps, mapDispatchToProps)(IncentiveSlabeAndAmountMasterBase);
