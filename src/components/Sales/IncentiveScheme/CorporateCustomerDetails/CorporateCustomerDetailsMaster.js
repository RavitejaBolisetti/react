...
const CorporateCustomerDetailsMasterBase = (props) => {
    ...
    const addDataTitle = (
        <p className={styles.textCenter}>
            Please add new corporate customer using <br /> <strong>“Add”</strong> button at top
        </p>
    );
                            ...
                            {isAddressLoading || isCorporateAddressLoading ? (
                                ...
                                <>
                                    <Row type="flex" align="middle">
                                        <Text strong> {'Corporate Customer Details'}</Text>
...
export const CorporateCustomerDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(CorporateCustomerDetailsMasterBase);
