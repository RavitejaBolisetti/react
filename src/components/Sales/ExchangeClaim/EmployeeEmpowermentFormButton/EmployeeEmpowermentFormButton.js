...
export const EmployeeEmpowermentFormButton = ({ record, onCloseAction, buttonData, setButtonData,handleExchangeClaimChangeHistory,handleApprovalChangeHistory, saveButtonName = translateContent('global.buttons.continue'), handleButtonClick, isLoadingOnSave, isLastSection, buttonType = false }) => {
    return (
