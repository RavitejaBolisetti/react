...
const ChangeHistoryMain = ({ fetchCustomerChangeHistory, onCloseAction, listShowChangeHistoryLoading, customerType, totalRecords, isChangeHistoryLoading, userId, isChangeHistoryLoaded, changeHistoryData, selectedCustomerId }) => {
    ...
    const tableColumn = [
        ...
        tblPrepareColumns({
            title: 'Claim Type' || translateContent('customerMaster.tableColHeading.modifiedBy'),
            dataIndex: 'calimType',
        ...
        tblPrepareColumns({
            title: 'Scheme Name' || translateContent('customerMaster.tableColHeading.changeSource'),
            dataIndex: 'source',
        }),
        tblPrepareColumns({
            title: 'Dealer Share Amount' || translateContent('customerMaster.tableColHeading.changeSource'),
            dataIndex: 'source',
        }),
        tblPrepareColumns({
            title: 'OEM Share Amount' || translateContent('customerMaster.tableColHeading.changeSource'),
            dataIndex: 'source',
        }),
        tblPrepareColumns({
            title: 'Total Claim Amount' || translateContent('customerMaster.tableColHeading.changeSource'),
            dataIndex: 'source',
        }),

        tblPrepareColumns({
            title: 'Approval Type' || translateContent('customerMaster.tableColHeading.changeSource'),
            dataIndex: 'source',
        }),

        tblPrepareColumns({
            title: 'Approved By' || translateContent('customerMaster.tableColHeading.changeSource'),
            dataIndex: 'source',
        }),
        tblPrepareColumns({
            title: 'Approved Date' || translateContent('customerMaster.tableColHeading.changeSource'),
            dataIndex: 'source',
        }),
        tblPrepareColumns({
            title: 'Scheme Name' || translateContent('customerMaster.tableColHeading.fieldName'),
            dataIndex: 'fieldName',
        }),
        
        tblPrepareColumns({
            title: 'Approved Dealer Amount' || translateContent('customerMaster.tableColHeading.changeSource'),
            dataIndex: 'source',
        }),
        tblPrepareColumns({
            title: 'Approved OEM Amount' || translateContent('customerMaster.tableColHeading.changeSource'),
            dataIndex: 'source',
        }),

        tblPrepareColumns({
            title: 'Total Approved Amount' || translateContent('customerMaster.tableColHeading.changeSource'),
            dataIndex: 'source',
        }),
        tblStatusColumn({ styles, width: '10%' }),

        tblPrepareColumns({
            title: 'Approval Action' || translateContent('customerMaster.tableColHeading.newValue'),
            dataIndex: 'newValue',
        }),
...
export const ApprovalChangeHistory = connect(mapStateToProps, mapDispatchToProps)(withDrawer(ChangeHistoryMain, { title: 'Change History', width: '90%' }));
