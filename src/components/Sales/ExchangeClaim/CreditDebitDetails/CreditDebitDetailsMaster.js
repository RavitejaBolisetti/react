...
const CreditDebitDetailsMain = (props) => {
    ...
    const onFinish = (data) => {
        console.log('🚀 ~ file:CreditDebitDetails.js:83 ~ onFinish ~ data:', data);
    };
...
export const CreditDebitDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(CreditDebitDetailsMain);
