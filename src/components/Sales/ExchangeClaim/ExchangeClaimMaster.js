...
import { ExchangeClaimMasterContainer } from './ExchangeClaimMasterContainer';
...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Exchange Claim';
...
export const ExchangeClaimMasterBase = (props) => {
    ...
    const [exchangeClaimchangeHistory, setExchangeClaimchangeHistory] = useState(false);
    const [approvalChangeHistory, setApprovalchangeHistory] = useState(false);
    ...
    const handleExchangeClaimChangeHistory = () => {
       setExchangeClaimchangeHistory(true);
        
    };

    const handleApprovalChangeHistory = () => {
        setApprovalchangeHistory(true);
    ...
    const containerProps = {
        ...
        isProductHierarchyLoading,
        handleApprovalChangeHistory,
        handleExchangeClaimChangeHistory,
    ...
    const approvalChangeHistoryProps = {
        isVisible: approvalChangeHistory,
        onCloseAction: () => {
            setApprovalchangeHistory(false);
        },
        titleOverride: 'Exchange Approval History',
        setIsFormVisible,
        buttonData,
        // selectedCustomerId,
        // ApprovalChangeHistoryTitle,
        // customerType,
    };
    
    const exchangeClaimChangehHistoryProps = {
        isVisible: exchangeClaimchangeHistory,
        onCloseAction: () => {
            setExchangeClaimchangeHistory(false);
        },
        titleOverride: 'Exchange Claim History',
        setIsFormVisible,
        buttonData,
        // selectedCustomerId,
        // ApprovalChangeHistoryTitle,
...
export const ExchangeClaimMaster = connect(mapStateToProps, mapDispatchToProps)(ExchangeClaimMasterBase);
