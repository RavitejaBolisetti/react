...
const ApplicableModelMain = (props) => {
    ...
    return (
        <Form layout="vertical" autoComplete="off" form={form} onValuesChange={handleFormValueChange} onFieldsChange={handleFormValueChange} onFinish={onFinish}>
            ...
            <Row>
                <Col xs={24} sm={24} md={24}pv lg={24} xl={24} xxl={24}>
                    <FormButton {...props} />
                </Col>
            </Row>
        </Form>
...
export const ApplicableModelMaster = connect(mapStateToProps, mapDispatchToProps)(ApplicableModelMain);
