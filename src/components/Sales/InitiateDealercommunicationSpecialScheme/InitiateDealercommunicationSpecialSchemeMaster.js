...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Initiate Dealer Communication';
...
export const InitiateDealercommunicationSpecialSchemeBase = (props) => {
    ...
    useEffect(() => {
        const defaultSection = INITIAL_DEALER_COMMUNICATION_SCHEME_SECTION.DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(INITIAL_DEALER_COMMUNICATION_SCHEME_SECTION);
...
export const InitiateDealercommunicationSpecialSchemeMaster = connect(mapStateToProps, mapDispatchToProps)(InitiateDealercommunicationSpecialSchemeBase);
