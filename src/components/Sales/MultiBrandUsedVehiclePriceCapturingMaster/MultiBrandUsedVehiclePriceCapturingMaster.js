...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Multi Brand Used Vehicle Price Capturing';
...
export const MultiBrandUsedVehiclePriceCapturingMasterBase = (props) => {
...
export const MultiBrandUsedVehiclePriceCapturingMaster = connect(mapStateToProps, mapDispatchToProps)(MultiBrandUsedVehiclePriceCapturingMasterBase);
