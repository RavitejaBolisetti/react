    ...
    const extraParams = useMemo(() => {
        return [
            ...
            },
            {
                ...
                name: modelData?.find((i) => i?.prodctCode === filterString?.oldModelGroup)?.prodctShrtName,
                canRemove: true,
                filter: true,
            },
            {
                ...
                name: modelData?.find((i) => i?.prodctCode === filterString?.newModelGroup)?.prodctShrtName,
                canRemove: true,
                filter: true,
            },
            {
