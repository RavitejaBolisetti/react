...
const VehicleDetailsCurrentMasterBase = (props) => {
...
export const VehicleDetailsCurrentMaster = connect(mapStateToProps, mapDispatchToProps)(VehicleDetailsCurrentMasterBase);
