...
import LetterDetailsMaster from './LetterDetails';
...
const SpecialIncentiveSchemesContainerMain = (props) => {
    ...
    const renderElement = () => {
        switch (currentSection) {
            case SPECIAL_INCENTIVE_SCHEME_SECTION.DETAILS.id: {
                return <HeaderDetailsMaster {...myProps} />;
            }
            case SPECIAL_INCENTIVE_SCHEME_SECTION.SCHEME_DETAILS.id: {
                return <SchemeDetailsMaster {...myProps} />;
            }
            case SPECIAL_INCENTIVE_SCHEME_SECTION.APPLICABLE_MODEL.id: {
                return <ApplicableModelMaster {...myProps} />;
            }
            case SPECIAL_INCENTIVE_SCHEME_SECTION.INITIATE_DEALER_COMMUNICAATION.id: {
                return <LetterDetailsMaster {...myProps} />;
            }
            case SPECIAL_INCENTIVE_SCHEME_SECTION.APPROVAL_REQUEST.id: {
