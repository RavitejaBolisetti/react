...
const LetterDetailsMasterBase = (props) => {
...
const LetterDetailsMaster = connect(mapStateToProps, mapDispatchToProps)(LetterDetailsMasterBase);
export default LetterDetailsMaster;
