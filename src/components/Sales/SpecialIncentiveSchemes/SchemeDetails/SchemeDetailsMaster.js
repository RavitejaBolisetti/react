...
import { Form, Row, Col, Collapse, Divider, Typography } from 'antd';
                        ...
                        <Panel
                            ...
                            header={
                                <Row justify="space-between">
                                    <Col xs={8} sm={8} md={8} lg={8} xl={8} className={styles.verticallyCentered}>
                                        <div className={styles.detailCardText}>
                                            <Text>Incntive Type : </Text>
                                            <span>{'N/A' || record?.incentiveType}</span>
                                        </div>
                                    </Col>
                                    <Col xs={8} sm={8} md={8} lg={8} xl={8} className={styles.verticallyCentered}>
                                        <div className={styles.detailCardText}>
                                            {'Modal Group'}
                                            <span>{record?.incentiveType}</span>
                                        </div>
                                    </Col>
                                    <Col xs={8} sm={8} md={8} lg={8} xl={8} className={styles.verticallyCentered}>
                                        <div className={styles.detailCardText}>
