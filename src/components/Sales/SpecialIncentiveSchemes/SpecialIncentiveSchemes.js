...
import { SPECIAL_INCENTIVE_SCHEME_SECTION } from 'constants/modules/IncentiveScheme/SpecialIncentiveSchemeSections';
...
const mapStateToProps = (state) => {
    ...
    const moduleTitle = 'Special Incentive Scheme';
...
export const SpecialIncentiveSchemesBase = (props) => {
    ...
    const [sectionName, setSetionName] = useState(SPECIAL_INCENTIVE_SCHEME_SECTION);
    ...
    const [pushIndicator, setPushIndicator] = useState(false);
    ...
    useEffect(() => {
        const defaultSection = SPECIAL_INCENTIVE_SCHEME_SECTION.DETAILS.id;
        setDefaultSection(defaultSection);
        setSetionName(
            pushIndicator
                ? SPECIAL_INCENTIVE_SCHEME_SECTION
                : Object.keys(SPECIAL_INCENTIVE_SCHEME_SECTION)
                      .filter((key) => key !== 'SCHEME_DETAILS')
                      .reduce((obj, key) => {
                          obj[key] = SPECIAL_INCENTIVE_SCHEME_SECTION[key];
                          return obj;
                      }, {})
        );
    ...
    const handleShowBudgetModel = ({ record }) => {};
    ...
    return (
        <>
            ...
            <SpecialIncentiveSchemesContainer {...containerProps} />
            {/* <BudgetListModal /> */}
        </>
    );
};

export const SpecialIncentiveSchemes = connect(mapStateToProps, mapDispatchToProps)(SpecialIncentiveSchemesBase);
