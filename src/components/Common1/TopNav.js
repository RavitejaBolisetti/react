...
function TopNav({ theme, userData }) {
        ...
        <>
            <div className="w-full h-max flex items-center justify-between py-[13px]">
                ...
                <div className="slg:block hidden">
                    <div className="flex">
                        <h1 className="text-[18px] font-bold">Welcome back {userData?.userId}!</h1>
                    </div>
                </div>
                            ...
                            <button className="flex items-end gap-[3px]">
                                <div className="sm:block hidden">
                                    <div className="flex flex-col items-start">
                                        <span className="text-[12px]">{userData?.userId}</span>
                            ...
                            {isOpen && (
                                <div className={`w-[166px] absolute top-[115%] sm:left-0 -left-[280%] ${theme === 'dark' ? 'bg-[#242424]' : 'bg-white'} rounded shadow-md`}>
                                    <ul className={`${theme === 'dark' ? 'divide-[#635D5D]' : 'divide-[#DEDEDE]'} divide-y`}>
                                        <li className="text-[12px] text-left p-[6px] px-[10px]" onClick={handleLogout}>
                                            Logout
                                        </li>
                                    </ul>
                                </div>
