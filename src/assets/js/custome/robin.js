...
$(document).ready(function () {
    $(".showOTP").click(function () {
        ...
        var downloadTimer = setInterval(function () {
            ...
            if (timeleft == 0) {
                document.getElementById("otpTimerID").style.display = "none";
    ...
    $(".addCountry").click(function () {
        $("#addCountryForm").show();
        $("#addPinForm").hide();
        $('.sectionName').text('Country');
    });
    $(".addState").click(function () {
        $("#addCountryForm").show();
        $("#addPinForm").hide();
        $('.sectionName').text('State');

    });
    $(".addDist").click(function () {
        $("#addCountryForm").show();
        $("#addPinForm").hide();
        $('.sectionName').text('District');
    });
    $(".addcity").click(function () {
        $("#addCountryForm").show();
        $("#addPinForm").hide();
        $('.sectionName').text('City/Tashil');
    });
    $(".addPin").click(function () {
        ...
        // $("#addCityForm").hide();
        $("#addPinForm").show();
        //$(".asiaCountryList").hide();
    });
    $(".asiaCountry").click(function () {
        $("#addCountryForm").hide();
        $("#addStateForm").hide();
        $("#addDistForm").hide();
        $("#addCityForm").hide();
        $("#addPinForm").hide();
        $(".asiaCountryList").show();
    });
    $(".advacedPasswordinfo").click(function () {
        /* $(window).scrollTop(0);
          $("body").css("overflow","hidden"); */
        $(".advaceFarmerSearch").show();

    });
    $(".advacedFarmerClose").click(function () {
        // $("body").css("overflow","scroll");
        $(".advaceFarmerSearch").hide();
    });
    $(".forgotinput").focusout(function () {
        $(".otpnum").show();
    });
    /* $("input[name=typeOTP]").click(function() {
      $(".showOTP").attr("disabled", !this.checked);
    }); */
    ...
    /* login button enable */
    let input = document.querySelector(".loginTextfield");
    let button = document.querySelector(".disabledButton");
    ...
    function stateHandle() {
        if (document.querySelector(".loginTextfield").value === "") {
            button.disabled = true;
...
/* Hieararchy Change Pop Up*/

$(document).ready(function () {
    $("#hierarchyChange").on('click', function () {
...
function toggleTheme() {
    ...
    /* if (document.getElementById("imgplus").src == "asset/img/light_image.png"){
        document.getElementById("imgplus").src = "asset/img/dark_image.png";
    } else {
        document.getElementById("imgplus").src = "asset/img/light_image.png";
    } */
}
function chngimg() {
    var img = document.getElementById('imgplus').src;
    if (img.indexOf('light_image.png') != -1) {
        document.getElementById('imgplus').src = 'asset/img/dark_image.png';
    }
    else {
        document.getElementById('imgplus').src = 'asset/img/light_image.png';
...
function buttonClicked() {
    // $("#hideDiv").show();
    $("#usserValidate").show();
    $("#usserValidate1, #usserValidate11, #addButtonMain ,#addDealerForm, #productHierarchy").hide();
    //  $("#usserValidate").css('display', 'show');
}
function buttonClicked1() {
    // $("#hideDiv").show();
    $("#usserValidate1").show();
    $("#usserValidate, #usserValidate2, #usserValidate3, #usserValidate4, #addButtonMain, #addDealerForm").hide();
    //  $("#usserValidate").css('display', 'show');
}
function buttonClicked2() {
    // $("#hideDiv").show();
    $("#usserValidate2").show();
    $("#usserValidate, #usserValidate1, #usserValidate3, #usserValidate4, #addButtonMain, #addDealerForm").hide();
    //  $("#usserValidate").css('display', 'show');
}
function buttonClicked3() {
    // $("#hideDiv").show();
    $("#usserValidate3").show();
    $("#usserValidate, #usserValidate1, #usserValidate2, #usserValidate4, #addButtonMain, #addDealerForm").hide();
    //  $("#usserValidate").css('display', 'show');
}
function buttonClicked4() {
    // $("#hideDiv").show();
    $("#usserValidate4").show();
    $("#usserValidate, #usserValidate1, #usserValidate2, #usserValidate3, #addButtonMain, #addDealerForm").hide();
    //  $("#usserValidate").css('display', 'show');
}
function buttonSave() {
    $("#addButtonMain").show();
...
// Nested Table Tree View - Ashutosh
(function () {
    $("span.fa-fw").on("click", function () {
        var $span = $(this),
            $parentTr = $span.closest("tr");

        //remove
        if ($span.hasClass("fa-rotate-180")) {
...
/* HTML Include another HTMl section - Ashutosh */
$(function () {
    $("#mainHeader").load("main_header.html");
    $("#leftSideMenu").load("left_side_menu.html");
    $("#mainFooter").load("main_footer.html");
});

// Grey Footer Movement - Ashutosh
...
$(window).scroll(function (e) {
    ...
    if ($('#footerSection').isInViewport()) {
        $('#greyFooter').css("bottom", (0 + $("#footerSection").visibleHeight()));
    }
    else {
        $('#greyFooter').css("bottom", 0);
    }
});
...
$(document).ready(function () {
    $("#hierarchyChange, #searchFilters").on('click', function () {
        $(".custom-model-main").addClass('model-open');
    });
    $(".close-btn, .bg-overlay, .cancelBtn").on('click', function () {
        $(".custom-model-main").removeClass('model-open');
    });
});
...
$('ul.tree li').on('click', function (e) {
    $(this).children('ul').show();
    $(this).siblings('li').find('ul').hide();
    e.stopPropagation();
});

$('ul.tree li a').on('click', function (e) {
    $(this).children('ul').hide();
    $(this).siblings('li').find('ul').hide();
    e.stopPropagation();
});

// GEO left menu div hide/show --------------.
$(document).ready(function () {
    $('.leftnav-tabs > li > a').click(function (event) {
        event.preventDefault(); //stop browser to take action for clicked anchor
        //get displaying tab content jQuery selector
        var active_tab_selector = $('.leftnav-tabs > li.active > a').attr('href');
        //find actived navigation and remove 'active' css
        var actived_nav = $('.leftnav-tabs > li.active');
...
// Show-Hide Geographical Hieararchy
$(function () {
    $("ul.tree li ul li.child a").click(function () {
        if ($(this).is(":checked")) {
            $("#existingUserID").show();
            $("#existingUserNext").show();
            $("#newUserID").hide();
            $("#newUserNextOne").hide();
            $("#newUserNextTwo").hide();
        } else {
            $("#existingUserID").hide();
            $("#existingUserNext").hide();
            $("#newUserID").show();
            $("#newUserNextOne").show();
        }
    });
